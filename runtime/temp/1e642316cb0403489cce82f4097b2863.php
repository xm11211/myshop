            ...
            <div class="widget-body">
                <div class="docs-example">
                    ...
                    <form id="adminForm" method="post" enctype="multipart/form-data" class="form-horizontal bv-form" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
                        <input type="hidden" name="id" value="<?php echo $frlinkData['id']; ?>">
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">

                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">链接名称</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $frlinkData['title']; ?>" class="form-control" name="title" data-bv-field="title"><i class="form-control-feedback" data-bv-icon-for="title" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="title" data-bv-result="NOT_VALIDATED" style="display: none;">链接名称不能为空！</small></div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-9" id="radioCate">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="type" type="radio" value="1" <?php if($frlinkData['type'] == 1): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 图片</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="type" type="radio" value="2" <?php if($frlinkData['type'] == 2): ?>checked<?php endif; ?> class="colored-blue">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="status" value="1" <?php if($frlinkData['status'] == 1): ?>checked<?php endif; ?> type="checkbox">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $frlinkData['url']; ?>" class="form-control" name="url" data-bv-field="url"><i class="form-control-feedback" data-bv-icon-for="url" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="stringLength" data-bv-for="url" data-bv-result="NOT_VALIDATED" style="display: none;">网址不要超过60位字符！</small></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">链接logo</label>
                                    <div class="col-lg-1">
                                        <span class="file-input btn btn-azure btn-file">
                                            选择文件<input type="file" name="pic">
                                        </span>
                                    </div>
                                    <?php if($frlinkData['pic'] != ''): ?>
                                    <div class="col-lg-2 col-md-2 col-sm-2" >
                                        <?php echo showImage($frlinkData['pic'],65,65); ?>
                                    </div>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" style="resize: none;height: 200px;" name="desc" data-bv-field="desc"><?php echo $frlinkData['desc']; ?></textarea><i class="form-control-feedback" data-bv-icon-for="desc" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="stringLength" data-bv-for="desc" data-bv-result="NOT_VALIDATED" style="display: none;">描述不要超过300位字符！</small></div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                desc: {
                    validators: {
                        stringLength: {
                            min: 1,
                            max: 300,
                            message: '描述不要超过300位字符！'
                        }
                    }
                },
            }
        });
        $("#sidebar-menu a[href*=frlink" + "\\/"+ "lst]").parent().addClass('active').parent().parent().addClass('open');
    });
</script>
