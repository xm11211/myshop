...
<div class="info">
    <p>待付款</p>
    <div class="num"><?php echo $notPayOrdersNum; ?></div>
</div>
</a>
    </li>
    <li>
...
<div class="info">
    <p>待收货</p>
    <div class="num"><?php echo $notReceiveOrdersNum; ?></div>
</div>
</a>
    </li>
    <li>
...
<div class="info">
    <p>待评价</p>
    <div class="num"><?php echo $notConfirmOrdersNum; ?></div>
</div>
</a>
    </li>
    <li>
...
<div class="info">
    <p>已完成</p>
    <div class="num"><?php echo $finishOrdersNum; ?></div>
</div>
</a>
    </li>
</ul>
...
<div class="info info-line">
    ...
    <li>
<div class="words"></div>
<div class="info info-line"><a href="#"><?php echo $userData['points']; ?></a></div>
    </li>
</ul>
<div class="user-mod">
...
<div class="user-title">
    <h2>我的订单</h2>
    <a href="<?php echo url('member/order/orderList'); ?>" class="more">查看所有订单</a>

</div>
<div class="user-index-order-list">
            <?php if(count($orders) >= 1): if(is_array($orders) || $orders instanceof \think\Collection || $orders instanceof \think\Paginator): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="tr">
                <div class="td td-goods">
                    <?php if(count($vo['orderGoods']) == 1): ?>
                    <div class="c-img"><a href="/goods/<?php echo $vo['orderGoods'][0]['goodsId']; ?>.html"><?php echo showImage($vo['orderGoods'][0]['smPic'],56,56); ?></a></div>
                    <div class="c-info"><?php echo $vo['orderGoods'][0]['goodsName']; ?></div>
                    <?php else: if(is_array($vo['orderGoods']) || $vo['orderGoods'] instanceof \think\Collection || $vo['orderGoods'] instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($vo['orderGoods']) ? array_slice($vo['orderGoods'],0,4, true) : $vo['orderGoods']->slice(0,4, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                    <div class="c-img"><a href="/goods/<?php echo $vo1['goodsId']; ?>.html"><?php echo showImage($vo1['smPic'],56,56); ?></a></div>
                    <?php endforeach; endif; else: echo "" ;endif; endif; ?>


                </div>
                <div class="td td-price"><em>¥</em><?php echo $vo['orderTotalPrice']; ?></div>
                <div class="td td-name"><?php echo $vo['name']; ?></div>
