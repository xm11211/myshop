    ...
    <div class="page-container">
        ...
        <div class="page-sidebar" id="sidebar">
            ...
            <ul id="sidebar-menu" class="nav sidebar-menu">
                ...
                <?php endif; if(authCheck('memberLevel/lst', session('aid')) or authCheck('authRule/lst', session('aid')) or authCheck('authGroup/lst', session('aid'))): ?>
                <li>
                    <a href="#" class="menu-dropdown">
            ...
            <div class="widget-body">
                <div class="docs-example">
                    <ul class="nav nav-tabs tabs-flat">
                        <li class="active"><a href="#info-tab" data-toggle="tab">订单修改</a></li>
                    </ul>
                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="radio">
                                            <span class="text"><?php echo $orderData['outTradeNo']; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="radio">
                                            <span class="text"><?php echo date('Y/m/d H:i:s',$orderData['orderTime']); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="radio">
                                            <span class="text"><?php echo $orderData['userName']; ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">商品总额</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $orderData['goodsTotalPrice']; ?>" class="form-control" name="goodsTotalPrice" data-bv-field="goodsTotalPrice"><i class="form-control-feedback" data-bv-icon-for="goodsTotalPrice" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="goodsTotalPrice" data-bv-result="NOT_VALIDATED" style="display: none;">商品总额不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">订单总额</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $orderData['orderTotalPrice']; ?>" class="form-control" name="orderTotalPrice" data-bv-field="orderTotalPrice"><i class="form-control-feedback" data-bv-icon-for="orderTotalPrice" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="orderTotalPrice" data-bv-result="NOT_VALIDATED" style="display: none;">订单总额不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="payment" type="radio" value="1" <?php if($orderData['payment'] == 1): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 支付宝</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="payment" type="radio" value="2" <?php if($orderData['payment'] == 2): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 微信</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="payment" type="radio" value="3" <?php if($orderData['payment'] == 3): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 微信第三方</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="payment" type="radio" value="4" <?php if($orderData['payment'] == 4): ?>checked<?php endif; ?> class="colored-blue">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="distribution" type="radio" value="申通" <?php if($orderData['distribution'] == '申通'): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 申通</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="distribution" type="radio" value="圆通" <?php if($orderData['distribution'] == '圆通'): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 圆通</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="distribution" type="radio" value="顺丰" <?php if($orderData['distribution'] == '顺丰'): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 顺丰</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="orderStatus" type="radio" value="0" <?php if($orderData['orderStatus'] == 0): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 未确认</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="orderStatus" type="radio" value="1" <?php if($orderData['orderStatus'] == 1): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 已确认</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="orderStatus" type="radio" value="2" <?php if($orderData['orderStatus'] == 2): ?>checked<?php endif; ?> checked class="colored-blue">
                                                <span class="text"> 申请退款</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="orderStatus" type="radio" value="3" <?php if($orderData['orderStatus'] == 3): ?>checked<?php endif; ?> checked class="colored-blue">
                                                <span class="text"> 退款成功</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="payStatus" type="radio" value="0" <?php if($orderData['payStatus'] == 0): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 未支付</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="payStatus" type="radio" value="1" <?php if($orderData['payStatus'] == 1): ?>checked<?php endif; ?> class="colored-blue">
                                ...
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">配送状态</label>
                                    <div class="col-lg-9">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="postStatus" type="radio" value="0" <?php if($orderData['postStatus'] == 0): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 未发货</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="postStatus" type="radio" value="1" <?php if($orderData['postStatus'] == 1): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 已发货</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="postStatus" type="radio" value="2" <?php if($orderData['postStatus'] == 2): ?>checked<?php endif; ?> class="colored-blue">
                                ...
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">运费</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $orderData['postSpant']; ?>" class="form-control" name="postSpant">
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">订单备注</label>
                                    <div class="col-lg-8">
                                        <textarea class="form-control" style="resize: none;height: 200px;" name="remark" data-bv-field="remark"><?php echo $orderData['remark']; ?></textarea><i class="form-control-feedback" data-bv-icon-for="remark" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="remark" data-bv-result="NOT_VALIDATED" style="display: none;">订单备注不要超过300位字符！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">收货人姓名</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $orderData['name']; ?>" class="form-control" name="name" data-bv-field="name"><i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="name" data-bv-result="NOT_VALIDATED" style="display: none;">收货人姓名不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">省份</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $orderData['province']; ?>" class="form-control" name="province" data-bv-field="province"><i class="form-control-feedback" data-bv-icon-for="province" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="province" data-bv-result="NOT_VALIDATED" style="display: none;">省份不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">市</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $orderData['city']; ?>" class="form-control" name="city" data-bv-field="city"><i class="form-control-feedback" data-bv-icon-for="city" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="city" data-bv-result="NOT_VALIDATED" style="display: none;">市不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">区</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $orderData['county']; ?>" class="form-control" name="county" data-bv-field="county"><i class="form-control-feedback" data-bv-icon-for="county" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="county" data-bv-result="NOT_VALIDATED" style="display: none;">市不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">具体地址</label>
                                    <div class="col-lg-8">
                                        <textarea class="form-control"  style="resize: none;height: 200px;" name="address" data-bv-field="address"><?php echo $orderData['address']; ?></textarea><i class="form-control-feedback" data-bv-icon-for="address" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="address" data-bv-result="NOT_VALIDATED" style="display: none;">具体地址不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">手机号</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $orderData['phone']; ?>" class="form-control" name="phone" data-bv-field="phone"><i class="form-control-feedback" data-bv-icon-for="phone" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="phone" data-bv-result="NOT_VALIDATED" style="display: none;">手机号不能为空！</small>
                                    </div>
                                </div>
