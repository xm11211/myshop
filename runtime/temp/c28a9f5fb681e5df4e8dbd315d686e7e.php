<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/goods/lst.html";i:1535001342;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="buttons-preview ">
                        <select class="input-xs" name="brandId">
                            <option value="" selected="selected">不限品牌</option>
                                <?php $brandId = input('get.brandId');foreach($bdData as $k => $v):
                                ?>
                        ...
                        <select class="input-xs" name="catId">
                            ...
                            <?php $catId = input('get.catId'); foreach($catData as $k => $v):
                            if($catId == $v['id']) {
                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                ...
                                暂无
                                <?php else: ?>
                                <?php echo $vo['brandName']; endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['cateName'] == ''): ?>
                                暂无
                                <?php else: ?>
                                <?php echo $vo['cateName']; endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['extCates'] == ''): ?>
                                暂无
                                <?php else: ?>
                                <?php echo $vo['extCates']; endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['pic'] == ''): ?>暂无
                                <?php else: ?>
                            ...
                            <td class="numeric"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php echo $vo['marketPrice']; ?>
                            </font></font></td>
                            <td class="numeric"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php echo $vo['shopPrice']; ?>
                            </font></font></td>
                            <td class="numeric"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['goodsNum'] != ''): ?><?php echo $vo['goodsNum']; else: ?>暂无<?php endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['onSale'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" field="onSale" goodsId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击下架</a>
                                <a class="btn btn-success btn-sm" style="display:none" field="onSale" value="1" goodsId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击上架</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" field="onSale" goodsId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击上架</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" field="onSale" value="0" goodsId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击下架</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td>
                                <a href="<?php echo url('goodsNum',array('id' => $vo['id'])); ?>" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> 库存</a>
                                <a href="<?php echo url('photos',array('id' => $vo['id'])); ?>" class="btn btn-darkorange btn-xs"><i class="glyphicon glyphicon-camera"></i> 商品相册</a>
