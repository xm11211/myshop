                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="userName" data-bv-field="userName"><i class="form-control-feedback" data-bv-icon-for="userName" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="eChecked" value="1"  type="checkbox">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="tel" data-bv-field="tel"><i class="form-control-feedback" data-bv-icon-for="tel" style="display: none;"></i>
                                    ...
                                    <div class="col-lg-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="tChecked" value="1"  type="checkbox">
                                            <span class="text"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="points" data-bv-field="points"><i class="form-control-feedback" data-bv-icon-for="points" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="between" data-bv-for="points" data-bv-result="NOT_VALIDATED" style="display: none;">积分不得超多16777215！</small></div>
                                </div>
