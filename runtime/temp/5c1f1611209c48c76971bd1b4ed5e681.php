<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/rec_pos/lst.html";i:1520038876;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['recType'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="2" field="recType" recpId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">切换为分类</a>
                                <a class="btn btn-success btn-sm" style="display:none" value="1" field="recType" recpId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">切换为商品</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" field="recType" recpId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">切换为商品</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" value="2" field="recType" recpId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">切换为分类</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td>
