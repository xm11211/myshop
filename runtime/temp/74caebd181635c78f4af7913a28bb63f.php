<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"F:\day\myshop\public/../application/admin\view\category\lst.html";i:1520214020;s:48:"F:\day\myshop\application\admin\view\layout.html";i:1515386558;s:55:"F:\day\myshop\application\admin\view\Common\header.html";i:1535520342;s:55:"F:\day\myshop\application\admin\view\Common\footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header  with-footer">
                <span class="widget-caption"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">商品分类列表</font></font></span>
            ...
            <div class="widget-body">
                <div class="buttons-preview">
                    <button class="btn btn-info btn-xs " id="linkAdd"><i class="fa fa-plus"></i> 添加分类</button>
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['cateImg'] != ''): ?>
                                <?php echo showImage($vo['cateImg'],56); else: ?>
                                暂无
                                <?php endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['status'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" field="status" categoryId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <a class="btn btn-success btn-sm" style="display:none" field="status" value="1" categoryId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" field="status" categoryId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" field="status" value="0" categoryId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td>
       ...
       $("a[name=off]").each(function (k,v) {
           $(v).on('click',function () {
               ...
               $.ajax({
                   ...
                   data:{value:"" + val +"",categoryId:"" + categoryId + "",field:"" + field + ""},
                   success:function (data) {
