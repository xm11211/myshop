                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['avator']): ?>
                                <?php echo showImage($vo['avator'],56); else: ?>
                                暂无
                                <?php endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php switch($vo['regType']): case "0": ?>邮箱<?php break; case "1": ?>手机<?php break; case "2": ?>全部<?php break; case "3": ?>暂无<?php break; endswitch; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['eChecked'] == 1): ?>
                                邮箱已验证
                                <?php elseif($vo['tChecked'] == 1): ?>
                                手机已验证
                                <?php elseif(($vo['eChecked'] == 1) and ($vo['tChecked'] == 1)): ?>
                                全部已验证
                                <?php else: ?>
                                未验证
                                <?php endif; ?>
