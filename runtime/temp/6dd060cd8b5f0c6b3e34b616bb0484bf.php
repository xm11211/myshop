            ...
            <div class="widget-body">
                <div class="docs-example">
                    ...
                    <form id="adminForm" method="post" enctype="multipart/form-data" class="form-horizontal bv-form" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
                        <input type="hidden" name="id" value="<?php echo $recpData['id']; ?>">
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">推荐位名称</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="recName" value="<?php echo $recpData['recName']; ?>" data-bv-field="recName"><i class="form-control-feedback" data-bv-icon-for="recName" style="display: none;"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="recType" type="radio" value="1" <?php if($recpData['recType'] == 1): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 商品</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="recType" type="radio" value="2" <?php if($recpData['recType'] == 2): ?>checked<?php endif; ?> class="colored-blue">
