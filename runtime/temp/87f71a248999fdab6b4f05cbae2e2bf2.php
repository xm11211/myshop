<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"K:\AMP\day\myshop\public/../application/member\view\order\orderDetail.html";i:1545109977;s:59:"K:\AMP\day\myshop\application\index\view\common\header.html";i:1544835140;s:58:"K:\AMP\day\myshop\application\member\view\common\left.html";i:1545282051;s:59:"K:\AMP\day\myshop\application\index\view\common\footer.html";i:1544835140;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="user-content clearfix">
    ...
    <div class="user-mod user-perinfo">
        <div class="profile clearfix">
            <div class="avatar">
                <a href="#" class="u-pic">
                    <?php echo showImage($userData['avator']); ?>
                </a>
            </div>
            <div class="name">
        ...
        <div class="side-menu">
            <dl>
                ...
                <dd>
                    ...
                    <p><a href="<?php echo url('member/address/address'); ?>" target="_self">收货地址</a></p>
                </dd>
            </dl>
            <dl>
    ...
    <div class="user-main" ectype="userMain" data-action="noDefault">
        ...
        <div class="user-mod user-order-detail" style="min-height: 1018px;">
            <div class="user-title">
                <h2>订单详情</h2>
                <a href="user.php?act=message_list&amp;is_order=1&amp;order_id=3" class="more">留言<em>&nbsp;&nbsp;(&nbsp;0&nbsp;)</em></a>
            </div>
            <div class="order-detail-statu">
                <div class="statu-left">
                    <p>
                    <?php switch($orders[0]['payStatus']): case "0": ?>未支付订单<?php break; case "1": ?>已支付订单<?php break; endswitch; ?>
                    <span style="color: deepskyblue;"></span>
                    </p>
                    <p>订单号：<?php echo $orders[0]['outTradeNo']; ?>
                    </p>
                </div>
            ...
            <ul class="order-detail-progress progress-<?php echo $progress; ?>">
                <li>下单时间<div class="tip"><?php echo date('Y/m/d H:i:s',$orders[0]['orderTime']); ?></div></li>
                <li>付款<div class="tip"><?php if($progress > 1): ?>已付款<?php endif; ?></div></li>
                <li>发货<div class="tip"><?php if($progress > 2): ?>已发货<?php endif; ?></div></li>
                <li>收货<div class="tip"><?php if($progress > 3): ?>已收货<?php endif; ?></div></li>
                <li>完成<div class="tip"><?php if($progress == 5): ?>已完成<?php endif; ?></div></li>
            </ul>
            <div class="user-info-list">
                ...
                <div class="info-content">
                    <div class="info-item">
                        ...
                        <div class="item-value"><?php echo $orders[0]['name']; ?></div>
                    </div>
                    <div class="info-item">
                        <div class="item-label">手机号码：</div>
                        <div class="item-value"><?php echo $orders[0]['phone']; ?></div>
                    </div>
                    <div class="info-item">
                        <div class="item-label">收货地址：</div>
                        <div class="item-value"><?php echo $orders[0]['province']; ?>  <?php echo $orders[0]['city']; ?>  <?php echo $orders[0]['county']; ?>&nbsp;<?php echo $orders[0]['address']; ?></div>
                    </div>
                </div>
            </div>
                ...
                <div class="info-content">
                    <div class="info-item">
                        ...
                        <div class="item-value">
                            <?php switch($orders[0]['payment']): case "1": ?>支付宝<?php break; case "2": ?>微信<?php break; case "3": ?>微信第三方<?php break; case "4": ?>余额<?php break; endswitch; ?>
                        </div>
                    </div>
                    <?php if($orders[0]['payStatus'] == 0): ?>
                    <div class="info-item">
                        <div class="item-label lh30">在线支付：</div>
                        <div class="item-value">
                            <a href="<?php echo url('index/flow/orderPay',array('oid' => $orders[0]['id'])); ?>" class="btn sc-redBg-btn btn30 ml5">去支付</a>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="info-item">
                        ...
                        <div class="item-value lh30">
                            <?php switch($orders[0]['payStatus']): case "0": ?>未付款<?php break; case "1": ?>已付款<?php break; endswitch; ?>
            ...
            <div class="user-info-list">
                ...
                <div class="info-content">
                    <div class="info-item">
                        ...
                        <div class="item-value" id="shipping_name_3"><?php echo $orders[0]['distribution']; ?></div>

                    </div>
                    <div class="info-item">
                        <div class="item-label">配送状态：</div>
                        <div class="item-value"> <?php switch($orders[0]['postStatus']): case "0": ?>未发货<?php break; case "1": ?>已发货<?php break; case "2": ?>已收货<?php break; endswitch; ?></div>
                    </div>
            ...
            <table class="user-table user-table-detail-goods">
                ...
                <tr>
                    <td>
                        <a href="/goods/<?php echo $vo['goodsId']; ?>" class="img"><?php echo showImage($vo['smPic'],70,70); ?></a>
                        <a href="/goods/<?php echo $vo['goodsId']; ?>" class="name"><?php echo $vo['goodsName']; ?></a>
                    </td>
                    <td><?php echo $vo['goodsAttrStr']; ?></td>
                    <td><?php echo $vo['num']; ?></td>
                    <td><p><em>¥</em><?php echo $vo['goodsMemberPrice']; ?></p><p>×<?php echo $vo['goodsNum']; ?></p></td>
                    <td>
                        <p class="ftx-01"><em>¥</em><?php echo $vo['subtotal']; ?></p>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
            ...
            <div class="user-order-detail-total">
                <dl class="total-row">
                    ...
                    <dd class="total-value"><?php echo $totalGoodsNum; ?>件</dd>
                </dl>
                <dl class="total-row">
                    <dt class="total-label">商品总价：</dt>
                    <dd class="total-value"><em>¥</em><?php echo $orders[0]['goodsTotalPrice']; ?></dd>
                </dl>

                <dl class="total-row">
                    <dt class="total-label">配送费用：</dt>
                    <dd class="total-value">+ <em>¥</em><?php echo $orders[0]['postSpant']; ?></dd>
                </dl>
                <dl class="total-row">
                    <dt class="total-label">
                        应付款：
                    </dt>
                    <dd class="total-value"><em>¥</em><?php echo $orders[0]['orderTotalPrice']; ?></dd>
                </dl>
            </div>
        </div>
        <script type="text/javascript">
            ...
            function checkOrder(){
                ...
                if(pay_code == 'wxpay'){
                    ...
                    $.get(url, {}, function(data){
                        ...
                        if(data.code == 1){
                            clearTimeout(timer);
                            location.href = "user.php?act=order_detail&order_id="+3;
                        }
                    },'json');
