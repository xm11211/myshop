<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/article/lst.html";i:1518762036;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['thumb'] == ''): ?>
                                    暂无
                                    <?php else: ?>
                                        <?php echo showImage($vo['thumb'],$vo['thumb'],56); endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['showTop'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" field="showTop" artId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击不置顶</a>
                                <a class="btn btn-success btn-sm" style="display:none" field="showTop" value="1" artId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击置顶</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" field="showTop" artId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击置顶</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" field="showTop" value="0" artId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击不置顶</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['showStatus'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" field="showStatus" artId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击隐藏</a>
                                <a class="btn btn-success btn-sm" style="display:none" value="1" field="showStatus" artId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击显示</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" artId="<?php echo $vo['id']; ?>" field="showStatus" name="on" href="javascript:void(0);">点击显示</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" value="0" field="showStatus" artId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击隐藏</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['cateName'] == ''): ?>请选择栏目<?php else: ?><?php echo $vo['cateName']; endif; ?>
...
<script>
   $(function () {
       //为按钮添加链接
       addBind('#adminAdd','<?php echo url('add'); ?>');
       // //表格数据行数
