<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"F:\day\myshop\public/../application/index\view\index\index.html";i:1520732238;s:55:"F:\day\myshop\application\index\view\common\header.html";i:1541134761;s:55:"F:\day\myshop\application\index\view\common\footer.html";i:1540963004;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="top-banner" style="background: rgb(255, 40, 125) none repeat scroll 0% 0%;">
    <div class="module w1200" data-type="range">
        ...
        <a href="#" target="_blank"><img src="/static/Home/img/1494985021864887905.jpg" width="1200" height="80"></a>
        <i class="iconfont icon-cha" ectype="close"></i>

    </div><div class="spec" data-spec="{&quot;picHeight&quot;:&quot;500&quot;,&quot;target&quot;:&quot;_blank&quot;,&quot;navColor&quot;:&quot;#ff287d&quot;,&quot;is_li&quot;:0,&quot;bg_color&quot;:[],&quot;pic_src&quot;:[&quot;/static/Home/img/1494985021864887905.jpg&quot;],&quot;link&quot;:&quot;&quot;,&quot;sort&quot;:[&quot;1&quot;]}"></div>
</div>
    ...
    <div class="content" style="min-height: 974px;"><div class="visual-item" data-mode="lunbo" data-purebox="banner" data-li="1" data-length="5" ectype="visualItme" style="display: block;" data-diff="0">
        ...
        <div class="view">
            <div class="banner home-banner">
                <div class="bd">
                    <ul data-type="range">
                        <?php if(is_array($sliders) || $sliders instanceof \think\Collection || $sliders instanceof \think\Paginator): $i = 0; $__LIST__ = $sliders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li style="background:url(/static/upload/<?php echo $vo['pic']; ?>) center center no-repeat;"><div class="banner-width"><a href="<?php echo $vo['url']; ?>" style="height:500px;"></a></div></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <div class="vip-con">
                        <div class="insertVipEdit" data-mode="insertVipEdit">
                            ...
                            <div ectype="user_info">
                                <div class="avatar">
                                    <a href="user.php?act=profile"><img src="/static/Home/img/avatar.png"></a>
                                </div>
                            ...
                            <div class="vip-item">
                                ...
                                <div class="con">
                                    <ul>
                                        <?php if(is_array($notArts) || $notArts instanceof \think\Collection || $notArts instanceof \think\Paginator): $i = 0; $__LIST__ = $notArts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <li><a href="/article/<?php echo $vo['id']; ?>" target="_blank"><?php echo $vo['title']; ?></a></li>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </ul>
                                    <ul style="display:none;">
                                        <?php if(is_array($proArts) || $proArts instanceof \think\Collection || $proArts instanceof \think\Paginator): $i = 0; $__LIST__ = $proArts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <li><a href="/article/<?php echo $vo['id']; ?>" target="_blank"><?php echo $vo['title']; ?></a></li>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </ul>
                                </div>
        ...
        <div class="visual-item w1200" ectype="channel"><div class="seckill-channel" id="h-seckill">
            ...
            <div class="box-bd clearfix">
                <div class="tempWrap" style="overflow:hidden; position:relative; width:1210px"><ul style="width: 3872px; position: relative; overflow: hidden; padding: 0px; margin: 0px; left: -1936px;"><li class="opacity_img clone" style="float: left; width: 232px;">
                    <div class="p-img"><a href="seckill.php?id=7" target="_blank"><img src="/static/Home/img/0_thumb_G_1489102299856.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=58" target="_blank"><img src="/static/Home/img/0_thumb_G_1489106192791.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=8" target="_blank"><img src="/static/Home/img/0_thumb_G_1489102753231.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=54" target="_blank"><img src="/static/Home/img/0_thumb_G_1490205126945.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=9" target="_blank"><img src="/static/Home/img/0_thumb_G_1489102950633.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=55" target="_blank"><img src="/static/Home/img/0_thumb_G_1490205156678.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=10" target="_blank"><img src="/static/Home/img/0_thumb_G_1490174741051.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=56" target="_blank"><img src="/static/Home/img/0_thumb_G_1490205189180.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=6" target="_blank"><img src="/static/Home/img/0_thumb_G_1489100550574.jpg" class="img-lazyload"></a></div>
                    ...
                    <li class="opacity_img" style="float: left; width: 232px;">
                        <div class="p-img"><a href="seckill.php?id=57" target="_blank"><img src="/static/Home/img/0_thumb_G_1490209796384.jpg" class="img-lazyload"></a></div>
        ...
        <div class="visual-item w1200" data-mode="h-need" data-purebox="homeAdv" data-li="1" ectype="visualItme" data-diff="0" style="display: block;">
            ...
            <div class="view">
                <div class="need-channel clearfix" id="h-need_0" data-type="range" data-lift="推荐">
                    ...
                    <div class="channel-column" style="background:url(/static/Home/img/1494984987302153402.jpg) no-repeat;">
                        <div class="column-title">
                            <h3 style="color: #ffffff">优质新品</h3>
                            <p style="color: #ffffff">专注生活美学</p>
                        </div>
                        <div class="column-img"><img src="/static/Home/img/1494985002375136884.png"></div>
                        <a href="" target="_blank" class="column-btn">去看看</a>
                    </div>
                    <div class="channel-column" style="background:url(/static/Home/img/1494984989930757668.jpg) no-repeat;">
                        <div class="column-title">
                            <h3 style="color: #ffffff">潮流女装</h3>
                            <p style="color: #ffffff">春装流行款抢购</p>
                        </div>
                        <div class="column-img"><img src="/static/Home/img/1494984989766362152.png"></div>
                        <a href="" target="_blank" class="column-btn">去看看</a>
                    </div>
                    <div class="channel-column" style="background:url(/static/Home/img/1494984989391013089.jpg) no-repeat;">
                        <div class="column-title">
                            <h3 style="color: #ffffff">人气美鞋</h3>
                            <p style="color: #ffffff">新外貌“鞋”会</p>
                        </div>
                        <div class="column-img"><img src="/static/Home/img/1494984990383161028.png"></div>
                        <a href="" target="_blank" class="column-btn">去看看</a>
                    </div>
                    <div class="channel-column" style="background:url(/static/Home/img/1494984987606903394.jpg) no-repeat;">
                        <div class="column-title">
                            <h3 style="color: #ffffff">品牌精选</h3>
                            <p style="color: #ffffff">潮牌尖货 初春换新</p>
                        </div>
                        <div class="column-img"><img src="/static/Home/img/1494984988032635434.png"></div>
                        <a href="" target="_blank" class="column-btn">去看看</a>
                    </div>
                    <div class="channel-column" style="background:url(/static/Home/img/1494984990175755536.jpg) no-repeat;">
                        <div class="column-title">
                            <h3 style="color: #ffffff">护肤彩妆</h3>
                            <p style="color: #ffffff">春妆必买清单 低至3折</p>
                        </div>
                        <div class="column-img"><img src="/static/Home/img/1494984991251825734.png"></div>
                        <a href="" target="_blank" class="column-btn">去看看</a>
                    </div>
            ...
            <div class="view">
                <div class="brand-channel clearfix" id="h-brand_0" data-type="range" data-lift="品牌">
                    ...
                    <div class="home-brand-adv slide_lr_info">
                        <a href="" target="_blank"><img src="/static/Home/img/1494984992104112514.jpg" class="slide_lr_img"></a>
                    </div>
                    <div ectype="homeBrand">
                        <div class="brand-list" id="recommend_brands" data-value="204,93,110,113,116,195,79,95,76,126,73,122,98,82,101,85,105">
                            <ul>
                                ...
                                <li>
                                    <div class="brand-img"><a href="/brand/<?php echo $vo['id']; ?>" target="_blank"><?php echo showImage($vo['pic']); ?></a></div>
                                </li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
        ...
        <div class="visual-item w1200" data-mode="homeFloor" data-purebox="homeFloor" data-li="1" ectype="visualItme" data-diff="0" style="display: block;">
            ...
            <div class="view">
                <div class="floor-content" data-type="range" id="homeFloor_0" data-lift="女装">
                    ...
                    <div class="floor-line-con floorOne floor-color-type-1" data-title="<?=$v['cateName']?>" data-idx="1" id="floor_1" ectype="floorItem">
                        <div class="floor-hd" ectype="floorTit">
                            <i class="box_hd_arrow"></i>
                            <i class="box_hd_dec"></i>
                            <div class="hd-tit"><?=$v['cateName']?></div>
                            <div class="hd-tags">
                                <ul>
                                    ...
                                    <?php if(isset($v['children'])):foreach($v['children'] as $k1 => $v1):?>
                                    <li data-catgoods="" class="first" ectype="floor_cat_content" data-flooreveval="0" data-visualhome="1" data-floornum="6" data-id="<?=$v1['id']?>">
                                        <span><?=$v1['cateName']?></span>
                                        <i class="arrowImg"></i>
                                    </li>
                        ...
                        <div class="floor-bd bd-mode-01">
                            <div class="bd-left">
                                <div class="floor-left-slide">
                                    <div class="bd">
                                        <ul>
                                            <?php if($v['firRecCateAd']['slider']):foreach($v['firRecCateAd']['slider'] as $k1 => $v1):?>
                                            <li><a href="<?=$v1['url']?>"><?=showImage($v1['pic'])?></a></li>
                                            <?php endforeach;endif;?>
                                        </ul>
                                    </div>
                                    <div class="hd"><ul></ul></div>
                                ...
                                <div class="floor-left-adv">
                                    <?php if($v['firRecCateAd']['rt']):?>
                                    <a href="<?=$v['firRecCateAd']['rt']['url']?>" target="_blank"><?=showImage($v['firRecCateAd']['rt']['pic'])?></a>
                                    <?php endif;if($v['firRecCateAd']['rb']):?>
                                    <a href="<?=$v['firRecCateAd']['rb']['url']?>" target="_blank"><?=showImage($v['firRecCateAd']['rb']['pic'])?></a>
                                    <?php endif;?>
                                </div>
                            ...
                            <div class="bd-right">
                                <div class="floor-tabs-content clearfix">
                                    <div class="f-r-main f-r-m-adv">
                                        <ul class="p-list">
                                        <?php if($v['firRecNewGoods']):foreach($v['firRecNewGoods'] as $k1 => $v1):?>
                                        <li class="opacity_img">
                                            <div class="product">
                                                <div class="p-img"><a href="/goods/<?=$v1['id'];?>" target="_blank"><?=showImage($v1['mdPic'],140,140);?></a></div>
                                                <div class="p-name"><a href="/goods/<?=$v1['id'];?>" title="<?=$v1['goodsName'];?>"><?=$v1['goodsName'];?></a></div>
                                                <div class="p-price">
                                <span class="shop-price">
                                                        <em>¥</em><?=$v1['shopPrice'];?></span>
                                                    <span class="original-price"><em>¥</em><?=$v1['marketPrice'];?></span>
                                                </div>
                                            </div>
                                        </li>
                                        <?php endforeach;endif?>
                                    ...
                                    <div class="f-r-main" ectype="floor_cat_347">
                                        <ul class="p-list">
                                            <?php if($v1['secRecNewGoods']):foreach($v1['secRecNewGoods'] as $k1 => $v1):?>
                                            <li class="opacity_img">
                                                <div class="product">
                                                    <div class="p-img"><a href="/goods/<?=$v1['id'];?>" target="_blank"><?=showImage($v1['mdPic'],140,140);?></a></div>
                                                    <div class="p-name"><a href="/goods/<?=$v1['id'];?>" title="<?=$v1['goodsName'];?>"><?=$v1['goodsName'];?></a></div>
                        ...
                        <div class="floor-fd">
                            <div class="floor-fd-brand clearfix">
                                <?php if($v['firRecBrands']):foreach($v['firRecBrands'] as $k => $v):?>
                                <div class="item">
                                    <a href="/brand/<?=$v['id']?>" target="_blank">
                                        <div class="link-l"></div>
                                        <div class="img"><?=showImage($v['pic'])?></div>
                                        <div class="link"></div>
                                    </a>
                                </div>
                                <?php endforeach;endif;?>
        ...
        <div class="visual-item w1200" data-mode="guessYouLike" data-purebox="goods" ectype="visualItme" data-diff="0" style="display: block;">
            ...
            <div class="view">
                <div class="lift-channel clearfix" id="guessYouLike" data-type="range" data-lift="商品">
                    ...
                    <ul>
                        <?php if(is_array($indexGoods) || $indexGoods instanceof \think\Collection || $indexGoods instanceof \think\Paginator): $i = 0; $__LIST__ = $indexGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li class="opacity_img">
                            <a href="goods/<?php echo $vo['id']; ?>" target="_blank">
                                <div class="p-img"><?php echo showImage($vo['mdPic']); ?></div>
                                <div class="p-name" title="<?php echo $vo['goodsName']; ?>"><?php echo $vo['goodsName']; ?></div>
                                <div class="p-price">
                                    <div class="shop-price">
                                        <em>¥</em><?php echo $vo['shopPrice']; ?>
                                    </div>
                                    <div class="original-price"><?php echo $vo['marketPrice']; ?> </div>
                                </div>
                            </a>
                        </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript" src="/static/Home/js/asyLoadfloor.js"></script>
