<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/conf/lst.html";i:1518826372;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="buttons-preview">
                    <button class="btn btn-info btn-xs " id="linkAdd"><i class="fa fa-plus"></i> 添加配置</button>
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php switch($vo['type']): case "1": ?>单行文本框<?php break; case "2": ?>多行文本 <?php break; case "3": ?>单选按钮<?php break; case "4": ?>复选按钮<?php break; case "5": ?>下拉菜单<?php break; case "6": ?>图片<?php break; endswitch; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['confType'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="2" field="confType" confId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">切换为商品配置</a>
                                <a class="btn btn-success btn-sm" style="display:none" field="confType" value="1" confId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">切换为网店配置</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" field="confType" confId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">切换为网店配置</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" field="confType" value="2" confId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">切换为商品配置</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['type'] == 6): if($vo['value'] != ''): ?>
                                <?php echo showImage($vo['value'],56); else: ?>
                                暂无缩略图
                                <?php endif; else: if($vo['value'] != ''): ?>
...
<script>
   $(function () {
       ...
       $("a[name=off]").each(function (k,v) {
           $(v).on('click',function () {
               ...
               $.ajax({
                   ...
                   data:{value:"" + val +"",confId:"" + confId + "",field:"" + field + ""},
                   success:function (data) {
       ...
       $("#sidebar-menu a[href*=conf" + "\\/"+ "lst]").parent().addClass('active').parent().parent().addClass('open');
