                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-9" id="radioType">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="position" type="radio" value="1" checked class="colored-blue">
                                                <span class="text"> 轮播</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="position" type="radio" value="2" class="colored-blue">
                                                <span class="text"> 右上</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="position" type="radio" value="3" class="colored-blue">
