<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"K:\AMP\day\myshop2\public/../application/admin\view\nav\lst.html";i:1519954266;s:53:"K:\AMP\day\myshop2\application\admin\view\layout.html";i:1515386558;s:60:"K:\AMP\day\myshop2\application\admin\view\Common\header.html";i:1531283152;s:60:"K:\AMP\day\myshop2\application\admin\view\Common\footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['navUrl'] == ''): ?>暂无
                                <?php else: ?>
                                <?php echo $vo['navUrl']; endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php switch($vo['pos']): case "1": ?>顶部<?php break; case "2": ?>中间<?php break; case "3": ?>底部<?php break; endswitch; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['open'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="2" field="open" navId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">切换为当前</a>
                                <a class="btn btn-success btn-sm" style="display:none" value="1" field="open" navId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">切换为新标签</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" field="open" navId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">切换为新标签</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" value="2" field="open" navId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">切换为当前</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td>
       ...
       $("a[name=off]").each(function (k,v) {
           $(v).on('click',function () {
               ...
               $.ajax({
                   ...
                   data:{value:"" + val +"",navId:"" + navId + "",field:"" + field + ""},
                   success:function (data) {
