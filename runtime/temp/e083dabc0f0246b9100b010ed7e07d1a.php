            ...
            <div class="widget-body">
                <div class="docs-example">
                    <ul class="nav nav-tabs tabs-flat">
                        <li class="active"><a href="#info-tab" data-toggle="tab">订单商品修改</a></li>
                    </ul>
                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $goodsData['goodsName']; ?>" class="form-control" name="goodsName" data-bv-field="goodsName"><i class="form-control-feedback" data-bv-icon-for="goodsName" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="goodsName" data-bv-result="NOT_VALIDATED" style="display: none;">商品名称不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">商品会员价</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $goodsData['goodsMemberPrice']; ?>" class="form-control" name="goodsMemberPrice" data-bv-field="goodsMemberPrice"><i class="form-control-feedback" data-bv-icon-for="goodsMemberPrice" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="goodsMemberPrice" data-bv-result="NOT_VALIDATED" style="display: none;">商品会员价不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">商品市场价</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $goodsData['goodsMarketPrice']; ?>" class="form-control" name="goodsMarketPrice" data-bv-field="goodsMarketPrice"><i class="form-control-feedback" data-bv-icon-for="goodsMarketPrice" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="goodsMarketPrice" data-bv-result="NOT_VALIDATED" style="display: none;">商品市场价不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">商品本店价</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $goodsData['goodsShopPrice']; ?>" class="form-control" name="goodsShopPrice" data-bv-field="goodsShopPrice"><i class="form-control-feedback" data-bv-icon-for="goodsShopPrice" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="goodsShopPrice" data-bv-result="NOT_VALIDATED" style="display: none;">商品本店价不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">商品属性</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $goodsData['goodsAttrStr']; ?>" class="form-control" name="goodsAttrStr" data-bv-field="goodsAttrStr"><i class="form-control-feedback" data-bv-icon-for="goodsAttrStr" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="goodsAttrStr" data-bv-result="NOT_VALIDATED" style="display: none;">商品属性不能为空！</small>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">商品数量</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $goodsData['goodsNum']; ?>" class="form-control" name="goodsNum" data-bv-field="goodsNum"><i class="form-control-feedback" data-bv-icon-for="goodsNum" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="goodsNum" data-bv-result="NOT_VALIDATED" style="display: none;">商品数量不能为空！</small>
                                    </div>
                                </div>
