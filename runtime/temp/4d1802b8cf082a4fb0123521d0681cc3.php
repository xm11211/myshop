            ...
            <div class="widget-body">
                <div class="docs-example">
                    ...
                    <form id="adminForm" method="post" enctype="multipart/form-data" class="form-horizontal bv-form" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
                        <input type="hidden" name="id" value="<?php echo $cbData['id']; ?>">
                            ...
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="radio">
                                            <span class="text">
                                                <?php echo $cbData['cateName']; ?>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">推荐品牌</label>
                                    <div class="col-lg-9" id="radioType">
                                        ...
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="brandId[]" type="checkbox" value="<?php echo $vo['id']; ?>" <?php if(in_array($vo['id'],$cbData['brandId'])): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> <?php echo $vo['brandName']; ?></span>
                                            </label>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2" >
                                        <?php echo showImage($cbData['pic'],65,65); ?>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">链接</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="url" value="<?php echo $cbData['url']; ?>" data-bv-field="url"><i class="form-control-feedback" data-bv-icon-for="url" style="display: none;"></i>
...
<script>
    $(document).ready(function () {
        ...
        $("#sidebar-menu a[href*=category_brands" + "\\/"+ "lst]").parent().addClass('active').parent().parent().addClass('open');
    });
</script>
