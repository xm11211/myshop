<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/www.xxsucai.com/public/../application/index/view/flow/order2.html";i:1540950821;s:70:"/www/wwwroot/www.xxsucai.com/application/index/view/common/footer.html";i:1540963003;}*/ ?>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/Home/css/calendar.min.css" />
</head>
...
<div class="header header-cart">
    ...
    <form action="<?php echo url('index/flow/order'); ?>" method="post" name="doneTheForm" class="validator" id="theForm">
        <div class="w w1200">
            <div class="checkout-warp">
                        ...
                        <div class="consignee-warp">
                            ...
                            <div class="user-form">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-value"><input type="text" name="bestTime" value="<?php echo $address['bestTime']; ?>" class="form-input"></div>
                                </div>
                                <div class="form-row">
                            ...
                            <div class="user-form">
                                ...
                                <div class="form-row">
                                    <div class="form-label"><span class="red">&nbsp;&nbsp;</span>最佳发货时间：</div>
                                    <div class="form-value"><input type="text" name="bestTime" value="" class="form-input"></div>
                                </div>
                                <div class="form-row">
                                    <div class="form-label"><span class="red">&nbsp;&nbsp;</span>邮政编码：</div>
                                ...
                                <div class="form-row">
                                    <div class="form-label"><span class="red">&nbsp;&nbsp;</span>地址别名：</div>
                                    <div class="form-value"><input type="text" name="signBuilding" value="" class="form-input"></div>
                                </div>
                ...
                <div class="ck-step checkout">
                    ...
                    <span>
                        <input type="radio" name="payment" value="1" checked="checked" />支付宝
                                ...
                                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" value="2" name="payment" />微信
                    </span>
                                    <b></b>
                                </div>
                                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" value="3" name="payment" />微信第三方
                    </span>
                                    <b></b>
                                </div>
                            </div>
                ...
                <div class="ck-step">
                    <div class="ck-step-tit">
                        <h3>商品信息</h3>
                        <a href="<?php echo url('index/flow/cart'); ?>" class="extra-r">返回购物车</a>
                    </div>
                    <div class="ck-step-cont">
                            ...
                            <div class="ck-goods-list">
                                <div class="ck-goods-item" ectype="shoppingList">
                                    ...
                                    <div class="ck-goods-cont">
                                        <?php if(is_array($goodsArr) || $goodsArr instanceof \think\Collection || $goodsArr instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <div class="ck-prom ck-prom-first">
                                            <div class="ck-prom-header">
                                                <div class="f-txt">
                                                    <span class="full-icon"><i class="i-left"></i>满赠<i class="i-right"></i></span>
                                                    <a href="javascript:;">
                                                        <span>活动商品已购满799.00元 ，可领取赠品</span>
                                                    </a>

                                                </div>
                                            </div>

                                            <div class="cg-item first">
                                                <div class="c-col cg-name">
                                                    <input name="cart_info[]" type="hidden" value="<?php echo $key; ?>|<?php echo $vo['goodsNumber']; ?>">
                                                    <a href="<?php echo $vo['id']; ?>" target="_blank">
                                                        <div class="p-img"><?php echo showImage($vo['mdPic'],48,48); ?></div>
                                                        <div class="p-info">
                                                            <div class="p-name"><?php echo $vo['goodsName']; ?></div>
                                                            <div class="p-attr"><?php echo $vo['goodsAttrStr']; ?></div>
                                                        </div>
                                                    </a>
                                                </div>

                                                <div class="c-col cg-price">
                                                    <span class="fr cl"><em>¥</em><?php echo $vo['shopPrice']; ?></span>
                                                </div>
                                                <div class="c-col cg-number">x<?php echo $vo['goodsNumber']; ?></div>
                                                <div class="c-col cg-state">
                        <span class="">
                                                           有货                               <!--<input name="rec_number" type="hidden" id="5" value="0">-->
                            															<!--<input name="shipping_prompt" type="hidden" id="5" value="0">-->
							                        </span>
                                                </div>
                                                <div class="c-col cg-sum"><em>¥</em><?php echo $vo['totalPrice']; ?></div>
                                            </div>
                ...
                <div class="order-summary">
                    <div class="statistic">
                        <div class="list">
                            ...
                            <em class="price" id="warePriceId"><em>¥</em><?php echo $goodsShopTotalPrice; ?></em>
                        </div>
                        <div class="list">
                            <span>应付总额：</span>
                            <em class="price-total"><em>¥</em><?php echo $goodsTotalPrice; ?></em>
                        </div>
                    </div>
                </div>
