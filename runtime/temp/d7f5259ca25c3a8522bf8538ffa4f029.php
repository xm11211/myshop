                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9" id="radioType">
                                        ...
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="brandId[]" type="checkbox" value="<?php echo $vo['id']; ?>" class="colored-blue">
