                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="typeName" value="<?php echo $typeData['typeName']; ?>" data-bv-field="typeName"><i class="form-control-feedback" data-bv-icon-for="typeName" style="display: none;"></i>
