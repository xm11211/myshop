                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            <td class="sorting_disabled" rowspan="1" colspan="1" aria-label="">
                                <label>
                                    <input type="checkbox" name="delId" value="<?php echo $vo['id']; ?>">
                                    <span class="text"></span>
                                </label>
                            </td>
                            <td class="numeric">
                                <input type="text" style="width:35px;" flag="sort" name="<?php echo $vo['id']; ?>" value="<?php echo $vo['sort']; ?>">
                            </td>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['pic'] == ''): ?>暂无
                                <?php else: ?>
                                <?php echo showImage($vo['pic'],56,56); endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php echo $vo['url']; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['type'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="2" field="type" frId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">切换为文字</a>
                                <a class="btn btn-success btn-sm" style="display:none" field="type" value="1" frId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">切换为图片</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" field="type" frId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">切换为图片</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" field="type" value="2" frId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">切换为文字</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['status'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" field="status" frId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <a class="btn btn-success btn-sm" style="display:none" field="status" value="1" frId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" field="status" frId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" field="status" value="0" frId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td>
   ...
   $(function () {
       ...
       $("#upSort").on('click',function (e) {
           ...
           $.ajax({
               ...
               success:function (data) {
                   if(data.code != 0){
                       location.href = "<?php echo url('lst',array('sort' => 'asc')); ?>";
                   }else{
       ...
       $("#downSort").on('click',function (e) {
           ...
           $.ajax({
               ...
               success:function (data) {
                   if(data.code != 0){
                       location.href = "<?php echo url('lst',array('sort' => 'desc')); ?>";
                   }else{
                       judgeEvents('#secMsg','click',data.msg,'danger','fa-bolt');
                   }
       ...
       $("a[name=off]").each(function (k,v) {
           $(v).on('click',function () {
               ...
               $.ajax({
                   ...
                   data:{value:"" + val +"",frId:"" + frId + "",field:"" + field + ""},
                   success:function (data) {
