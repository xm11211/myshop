<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/index/index.html";i:1521181560;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
        <div class="widget">
            ...
            <div class="widget-body">
                <button href="<?php echo url('admin/edit',array('id'=>\think\Request::instance()->session('aid'))); ?>" type="button" class="btn btn-default"><i class="fa fa-user"></i>
                    <font style="vertical-align: center;"><font style="vertical-align: center;"> 修改密码</font>
                    </font>
                </button>
                <button href="<?php echo url('conf/conf'); ?>" type="button" class="btn btn-default"><i class="fa fa-gear"></i>
                    <font style="vertical-align: center;"><font style="vertical-align: center;"> 网站配置</font>
                    </font>
                </button>
                <button href="<?php echo url('cate/add'); ?>" type="button" class="btn btn-default"><i class="fa fa-folder"></i>
                    <font style="vertical-align: center;"><font style="vertical-align: center;"> 新增栏目</font>
                    </font>
                </button>
                <button href="<?php echo url('article/add'); ?>" type="button" class="btn btn-default"><i class="fa fa-file-text"></i>
                    <font style="vertical-align: center;"><font style="vertical-align: center;"> 新增文章</font>
                    </font>
                </button>
                <button href="<?php echo url('admin/clear'); ?>" id="clearCache2" type="button" class="btn btn-default"><i class="fa fa-trash-o"></i>
        ...
        <div class="well with-header  with-footer">
            ...
            <table class="table table-hover table-striped table-bordered table-condensed">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo \think\Request::instance()->session('pc'); ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <?php echo \think\Request::instance()->session('osname'); ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                       <?php echo \think\Request::instance()->session('apacheVer'); ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <?php echo \think\Request::instance()->session('port'); ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <?php echo \think\Request::instance()->session('mysql_version'); ?>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <div class="myweather col-lg-4 col-md-12 col-sm-12 col-xs-12">
        <div class="databox databox-vertical databox-xxxlg radius-bordered databox-shadowed" style="height:700px;">
            <div class="databox-top bg-orange text-align-left padding-left-30">
                <span class="databox-header"><i class="glyphicon glyphicon-map-marker"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" id="city"> <?php echo $weaTo['city']; ?></font></font></span>
            </div>
            <div class="databox-bottom no-padding bg-sky" style="height:650px;">
                <div class="databox-row row-5 bg-yellow padding-20 text-align-left">
                    <span class="databox-text padding-bottom-5" style="font-size:25px;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" id="time"> <?php echo $date; ?></font></font></span>
                    <span class="databox-number" style="font-size:38px;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" id="weaText"><?php echo $rtWeather['text']; ?>&nbsp;&nbsp;<?php echo $rtWeather['temperature']; ?>°&nbsp;&nbsp;</font></font><i id='weaCate' class="wi <?php echo $rtWeather['cate']; ?>"></i> <span style="font-size:17px;">(实时)</span></span>
                    <span class="mytext databox-text padding-bottom-5"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">穿衣指数：<?php echo $weaTo['dressing_index']; ?>,<?php echo $weaTo['dressing_advice']; ?></font></font></span>
                    <span class="mytext databox-text padding-bottom-5"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">紫外线强度：<?php echo $weaTo['uv_index']; ?></font></font></span>
                </div>
                <?php if(is_array($weaFu) || $weaFu instanceof \think\Collection || $weaFu instanceof \think\Paginator): $k = 0; $__LIST__ = $weaFu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;switch($k): case "7": ?>
                            <div class="databox-row row-1 padding-5 padding-left-30 text-align-left">
                                <div class="databox-cell cell-4">
                                    <span class="databox-title margin-top-10"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" class="mytext2"><?php echo $vo['week']; ?></font></font></span>
                                </div>
                                <div class="databox-cell cell-4">
                                    <span class="databox-title margin-top-10"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" class="mytext2"><?php echo $vo['weather']; ?></font></font></span>
                                </div>
                                <div class="databox-cell cell-4">
                                    <span class="databox-number margin-top-10"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" class="mytext2"><?php echo $vo['temperature']; ?></font></font></span>
                                </div>
                            </div>
                        <?php break; default: ?>
...
<script>
    ...
    function updateRealWeather() {
        ...
        if(str.test(cookie)) {
            ...
            $.ajax({
                url:"<?php echo url('updateRealWea'); ?>",
                type:'get',
                success:function (data) {
