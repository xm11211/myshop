<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/admin/lst.html";i:1518678124;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php echo $vo['adminName']; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['pic'] == ''): ?>
                                    暂无
                                    <?php else: ?>
                                        <?php echo showImage($vo['pic'],$vo['pic'],56); endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if(isset($vo['group'])): if(is_array($vo['group']) || $vo['group'] instanceof \think\Collection || $vo['group'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['group'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;if($vo['id'] == 5): ?>
                                    <?php echo $vo1['title']; ?>（顶级管理员）
                                    <?php else: ?>
                                    <?php echo $vo1['title']; ?><br />
