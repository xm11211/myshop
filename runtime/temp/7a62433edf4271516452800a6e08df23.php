<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/auth_group/lst.html";i:1518576938;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['status'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" groupId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <a class="btn btn-success btn-sm" style="display:none" value="1" groupId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" groupId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" value="0" groupId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td>
