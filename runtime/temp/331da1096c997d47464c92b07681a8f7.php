            ...
            <div class="widget-body">
                <div class="docs-example">
                    ...
                    <form id="adminForm" method="post" enctype="multipart/form-data" class="form-horizontal bv-form" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
                        <input type="hidden" name="id" value="<?php echo $attrData['id']; ?>">
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="attrName" value="<?php echo $attrData['attrName']; ?>" data-bv-field="attrName"><i class="form-control-feedback" data-bv-icon-for="attrName" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="radio">
                                            <span class="text">
                                                <?php switch($attrData['attrType']): case "1": ?>单选<?php break; case "2": ?>唯一<?php break; endswitch; ?>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <?php if($attrData['attrType'] == 1): ?>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">属性值</label>
                                    <div class="col-lg-8">
                                        <textarea id="attrValues" name="attrValues" placeholder="多个值用逗号分隔" style="resize: none;height:100px;" class="form-control" data-bv-field="attrValues"><?php echo $attrData['attrValues']; ?></textarea><i class="form-control-feedback" data-bv-icon-for="attrValues" style="display: none;"></i>
