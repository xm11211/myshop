...
<div class="user-content clearfix">
    ...
    <div class="user-main" ectype="userMain" data-action="noDefault">
        ...
        <div class="user-mod" style="min-height: 1018px;">
            ...
            <div class="user-form">
                <form action="<?php echo url('member/address/address'); ?>" method="post" class="user-address-form" name="theForm" novalidate="novalidate">
                    <div class="form-row">
                        <div class="form-label"><span class="red">*</span>收货人：</div>
                        <div class="form-value"><input type="text" name="name" value="<?php echo $address['name']; ?>" class="form-input"><div class="form_prompt"></div></div>
                    </div>
                    <div class="form-row">
                        <div class="form-label"><span class="red">*</span>手机号码：</div>
                        <div class="form-value">
                            <input type="text" name="phone" value="<?php echo $address['phone']; ?>" class="form-input">
                            <span class="fl">电话号码：</span>
                            <input type="text" name="tel" value="<?php echo $address['tel']; ?>" class="form-input">
                        ...
                        <div class="form-value">
                            <div class="info">
                                <div>
                                    ...
                                    <script class="resources library" src="/static/Home/js/area.js" type="text/javascript"></script>
                                </div>
                            </div>
                            <script type="text/javascript">
                                _init_area();
                                ...
                                var county = "<?php echo $address['county']; ?>";
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-value"><input type="text" name="address" value="<?php echo $address['address']; ?>" class="form-input form-input-long"><div class="form_prompt"></div></div>
                    </div>
                    <div class="form-row">
                        <div class="form-label"><span class="red">&nbsp;&nbsp;</span>电子邮箱：</div>
                        <div class="form-value"><input type="text" name="email" value="<?php echo $address['email']; ?>" class="form-input"><div class="form_prompt"></div></div>
                    </div>
                    <div class="form-row">
                        <div class="form-label"><span class="red">&nbsp;&nbsp;</span>邮政编码：</div>
                        <div class="form-value"><input type="text" name="zipcode" value="<?php echo $address['zipcode']; ?>" class="form-input"></div>
                    </div>
                    <div class="form-row">
                        <div class="form-label"><span class="red">&nbsp;&nbsp;</span>地址别名：</div>
                        <div class="form-value"><input type="text" name="signBuilding" value="<?php echo $address['signBuilding']; ?>" class="form-input"></div>
                    </div>
                    <div class="form-btn-wp">
                        <?php echo token('addr'); ?>
                        <input type="hidden" name="userId" value="<?php echo \think\Session::get('uid'); ?>"  />
                        <input type="submit" class="form-btn" value="保存收货地址" id="submitAddress">
                        <input type="reset" name="reset" id="reset" class="form-btn form-btn-gray" value="重 置">
                        <script>
                            //重置按钮
