                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" value="<?php echo $cateData['cateName']; ?>" name="cateName" data-bv-field="cateName"><i class="form-control-feedback" data-bv-icon-for="cateName" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" value="<?php echo $cateData['iconName']; ?>" name="iconName" data-bv-field="iconName"><i class="form-control-feedback" data-bv-icon-for="iconName" style="display: none;"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($cateData['cateImg'] != ''): ?>
                                    <div class="col-lg-2 col-md-2 col-sm-2" >
                                        <?php echo showImage($cateData['cateImg'],$cateData['cateImg'],65,65); ?>
                                    </div>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" value="<?php echo $cateData['keywords']; ?>" name="keywords" placeholder="多个关键词用逗号分隔" data-bv-field="keywords"><i class="form-control-feedback" data-bv-icon-for="keywords" style="display: none;"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="status" value="1" <?php if($cateData['status'] == 1): ?>checked<?php endif; ?>  type="checkbox">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="psNum" value="<?php echo $cateData['psNum']; ?>" data-bv-field="psNum"><i class="form-control-feedback" data-bv-icon-for="psNum" style="display: none;"></i>
                                ...
                                <?php if($attrTypeArr): if(is_array($attrTypeArr) || $attrTypeArr instanceof \think\Collection || $attrTypeArr instanceof \think\Paginator): $k = 0; $__LIST__ = $attrTypeArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">筛选属性</label>
                                        <div class="col-lg-2 type">
                                            <select class="form-control" name="typeId[]">
                                                <option value="0">请选择</option>
                                                <?php if(is_array($typeData) || $typeData instanceof \think\Collection || $typeData instanceof \think\Paginator): $i = 0; $__LIST__ = $typeData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $vo1['id']; ?>" <?php if($vo['typeId'] == $vo1['id']): ?>selected<?php endif; ?>><?php echo $vo1['typeName']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                        <?php if($vo['attrs']): ?>
                                        <div class="col-lg-2 attrId">
                                            <select class="form-control" name="attrId[]">
                                                <option value="0">请选择</option>
                                                <?php if(is_array($vo['attrs']) || $vo['attrs'] instanceof \think\Collection || $vo['attrs'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['attrs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $vo2['id']; ?>" <?php if($vo['attrId'] == $vo2['id']): ?>selected<?php endif; ?>><?php echo $vo2['attrName']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                        <?php endif; if($k > 1): ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2 type">
                                        <select class="form-control" name="typeId[]">
                                            <option value="0">请选择</option>
                                            <?php if(empty($typeData) || (($typeData instanceof \think\Collection || $typeData instanceof \think\Paginator ) && $typeData->isEmpty())): else: if(is_array($typeData) || $typeData instanceof \think\Collection || $typeData instanceof \think\Paginator): $i = 0; $__LIST__ = $typeData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea name="desc" style="resize: none;height:100px;" class="form-control" data-bv-field="desc"><?php echo $cateData['desc']; ?></textarea><i class="form-control-feedback" data-bv-icon-for="desc" style="display: none;"></i>
