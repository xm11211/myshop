            ...
            <div class="widget-body">
                ...
                <div class="buttons-preview ">
                    ...
                    <select class="input-xs" name="attrType">
                        ...
                        <option value="" <?php if($attrType == ''): ?>selected="selected"<?php endif; ?>>不限属性类型</option>
                        <option value="1" <?php if($attrType == 1): ?>selected="selected"<?php endif; ?>>单选</option>
                        <option value="2" <?php if($attrType == 2): ?>selected="selected"<?php endif; ?>?>唯一</option>
                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php echo $vo['attrName']; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['attrType'] == 1): ?>
                                单选
                                <?php else: ?>
                                唯一
                                <?php endif; ?>
