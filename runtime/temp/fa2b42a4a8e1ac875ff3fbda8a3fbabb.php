<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"K:\AMP\day\myshop2\public/../application/admin\view\nav\edit.html";i:1519954266;s:53:"K:\AMP\day\myshop2\application\admin\view\layout.html";i:1515386558;s:60:"K:\AMP\day\myshop2\application\admin\view\Common\header.html";i:1531283152;s:60:"K:\AMP\day\myshop2\application\admin\view\Common\footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="widget  radius-bordered">
            <div class="widget-header bg-themeprimary">
                <span class="widget-caption">导航管理</span>
            </div>
                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">导航名称</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $navData['navName']; ?>" class="form-control" name="navName" data-bv-field="navName"><i class="form-control-feedback" data-bv-icon-for="navName" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="navName" data-bv-result="NOT_VALIDATED" style="display: none;">导航名称不能为空！</small></div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">导航地址</label>
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $navData['navUrl']; ?>" class="form-control" name="navUrl" data-bv-field="navUrl"><i class="form-control-feedback" data-bv-icon-for="navUrl" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="stringLength" data-bv-for="navUrl" data-bv-result="NOT_VALIDATED" style="display: none;">导航地址不能为空！</small></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="open" type="radio" value="1" <?php if($navData['open'] == 1): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 新标签</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="open" type="radio" value="2" <?php if($navData['open'] == 2): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 当前页</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="pos" type="radio" value="1" <?php if($navData['pos'] == 1): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 顶部</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="pos" type="radio" value="2" <?php if($navData['pos'] == 2): ?>checked<?php endif; ?> class="colored-blue">
                                                <span class="text"> 中间</span>
                                            </label>
                                        </div>
                                        <div class="radio col-lg-2">
                                            <label>
                                                <input name="pos" type="radio" value="3" <?php if($navData['pos'] == 3): ?>checked<?php endif; ?> class="colored-blue">
...
<script>
    $(document).ready(function () {
        ...
        $("#sidebar-menu a[href*=nav" + "\\/"+ "lst]").parent().addClass('active').parent().parent().addClass('open');
    });
</script>
