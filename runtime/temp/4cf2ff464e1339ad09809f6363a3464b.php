                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="userName" value="<?php echo $userData['userName']; ?>" data-bv-field="userName"><i class="form-control-feedback" data-bv-icon-for="userName" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="email" value="<?php echo $userData['email']; ?>" data-bv-field="email"><i class="form-control-feedback" data-bv-icon-for="email" style="display: none;"></i>
                                    ...
                                    <div class="col-lg-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="eChecked" value="1" <?php if($userData['eChecked'] == 1): ?>checked<?php endif; ?>  type="checkbox">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" name="tel" value="<?php echo $userData['tel']; ?>" data-bv-field="tel"><i class="form-control-feedback" data-bv-icon-for="tel" style="display: none;"></i>
                                    ...
                                    <div class="col-lg-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="tChecked" value="1" <?php if($userData['tChecked'] == 1): ?>checked<?php endif; ?>  type="checkbox">
                                            <span class="text"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="points" value="<?php echo $userData['points']; ?>" data-bv-field="points"><i class="form-control-feedback" data-bv-icon-for="points" style="display: none;"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($userData['avator'] != ''): ?>
                                    <div class="col-lg-2 col-md-2 col-sm-2" >
                                        <?php echo showImage($userData['avator'],65,65); ?>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
