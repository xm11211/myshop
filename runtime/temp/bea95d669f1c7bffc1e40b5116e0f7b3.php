<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/cate/lst.html";i:1531294874;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php echo str_repeat('-',$vo['level'] * 4); ?><?php echo $vo['cateName']; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php switch($vo['type']): case "1": ?>系统分类<?php break; case "2": ?>帮助分类<?php break; case "3": ?>网店帮助<?php break; case "4": ?>网店信息<?php break; case "5": ?>普通分类<?php break; endswitch; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if(empty($vo['keywords']) || (($vo['keywords'] instanceof \think\Collection || $vo['keywords'] instanceof \think\Paginator ) && $vo['keywords']->isEmpty())): ?>
                                暂无
                                <?php else: ?>
                                <?php echo $vo['keywords']; endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['showNav'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" cateId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击隐藏</a>
                                <a class="btn btn-success btn-sm" style="display:none" value="1" cateId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击显示</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" cateId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击显示</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" value="0" cateId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击隐藏</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php echo $vo['pid']; ?>
                            ...
                            <td>
                                <?php if(($vo['pid'] == 4) OR ($vo['id'] == 8) OR ($vo['type'] == 5)): ?>
                                    <button value="<?php echo $vo['id']; ?>" name="see" data-toggle="modal" data-target="#myModal" class="btn btn-purple btn-xs"><i class="fa fa-search-plus"></i>查看文章</button>
                                <?php endif; ?>
                                <a href="<?php echo url('edit',array('id' => $vo['id'])); ?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> 修改</a>
                                <?php if(($vo['id'] != 5) AND ($vo['id'] != 8) AND ($vo['id'] != 4)): ?>
...
<script>
   $(function () {
       ...
       //文章查看
       ajaxSee('button[name=see]',"<?php echo url('search'); ?>","<?php echo url('/admin/article/edit/id'); ?>");
