<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/brand/lst.html";i:1520546788;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="buttons-preview">
                    <button class="btn btn-info btn-xs " id="linkAdd"><i class="fa fa-plus"></i> 添加品牌</button>
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['status'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" brandId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <a class="btn btn-success btn-sm" style="display:none" value="1" brandId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" brandId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" value="0" brandId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td>
       ...
       $("a[name=off]").each(function (k,v) {
           $(v).on('click',function () {
               ...
               $.ajax({
                   ...
                   data:{value:"" + val +"",brandId:"" + brandId + ""},
                   success:function (data) {
