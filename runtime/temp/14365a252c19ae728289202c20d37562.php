    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="widget  radius-bordered">
            <div class="widget-header bg-themeprimary">
                <span class="widget-caption">推荐词管理</span>
            </div>
                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group">
                                    ...
                                    <?=buildSelect('category','cateId','id','cateName','',8,array('pid' => 0));?>
                                </div>
                                <div class="form-group has-feedback">
                                    <label class="col-lg-2 control-label">词汇</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="word" data-bv-field="word"><i class="form-control-feedback" data-bv-icon-for="word" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="word" data-bv-result="NOT_VALIDATED" style="display: none;">词汇不能为空！</small></div>
                                </div>
                                <div class="form-group has-feedback">
