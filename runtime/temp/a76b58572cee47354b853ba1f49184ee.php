    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header  with-footer">
                <span class="widget-caption"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">轮播图</font></font></span>
            ...
            <div class="widget-body">
                <div class="buttons-preview">
                    <button class="btn btn-info btn-xs " id="linkAdd"><i class="fa fa-plus"></i> 添加轮播图</button>
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tr>
                            ...
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo['status'] == 1): ?>
                                <a class="btn btn-darkorange btn-sm" value="0" sliderId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <a class="btn btn-success btn-sm" style="display:none" value="1" sliderId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <?php else: ?>
                                <a class="btn btn-success btn-sm" value="1" sliderId="<?php echo $vo['id']; ?>" name="on" href="javascript:void(0);">点击启用</a>
                                <a class="btn btn-darkorange btn-sm" style="display:none" value="0" sliderId="<?php echo $vo['id']; ?>" name="off" href="javascript:void(0);">点击禁用</a>
                                <?php endif; ?>
                            </font></font></td>
                            <td>
...
<script>
   $(function () {
       ...
       $("a[name=off]").each(function (k,v) {
           $(v).on('click',function () {
               ...
               $.ajax({
                   ...
                   data:{value:"" + val +"",sliderId:"" + sliderId + ""},
                   success:function (data) {
       ...
       $("#sidebar-menu a[href*=slider" + "\\/"+ "lst]").parent().addClass('active').parent().parent().addClass('open');
   });
</script>
