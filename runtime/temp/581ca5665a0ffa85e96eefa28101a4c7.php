<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\day\myshop\public/../application/member\view\order\orderList.html";i:1543730895;s:55:"F:\day\myshop\application\index\view\common\header.html";i:1541134761;s:55:"F:\day\myshop\application\index\view\common\footer.html";i:1540963004;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="user-main" ectype="userMain" data-action="noDefault">
        ...
        <div class="user-mod" style="min-height: 1018px;">
            <div class="user-title">
                <h2>我的订单</h2>
                <ul class="tabs">
                    <li class="active"><a href="user.php?act=order_list">全部订单(<?php echo $ordersNum; ?>)</a></li>
                    <li class="user-count3 " onclick="get_OrderSearch('to_unconfirmed', 'order_list', 'toBe_unconfirmed','','.user-count3')">
                        <a href="javascript:void(0);">待确认(1)</a>
                        <input name="to_unconfirmed" id="to_unconfirmed" type="hidden" value="0">
                    </li>
                    <li class="user-count1 " onclick="get_OrderSearch('payId', 'order_list', 'toBe_pay','','.user-count1')">
                        <a href="javascript:void(0);">待付款(0)</a>
                        <input name="toBe_pay" id="payId" type="hidden" value="100">
                    </li>
                    <li class="user-count2 " onclick="get_OrderSearch('to_confirm_order', 'order_list', 'toBe_confirmed','','.user-count2')">
                        <a href="javascript:void(0);">待收货(0)</a>
                        <input name="to_confirm_order" id="to_confirm_order" type="hidden" value="103">
                    </li>
                    <li class="user-count4 " onclick="get_OrderSearch('to_finished', 'order_list', 'toBe_finished','','.user-count4')">
                        <a href="javascript:void(0);">已完成(0)</a>
                    ...
                    <dl class="item">
                        <dt class="item-t item-t-qb">
                            ...
                            <div class="t-info">
                                ...
                                <span class="info-item"> <?php echo \think\Request::instance()->session('username'); ?></span>
                            </div>
                        ...
                        <dd class="item-c">
                            <div class="c-left">
                                ...
                                <div class="c-goods" ectype="c-goods">
                                    <div class="c-img"><a href="goods.php?id=843"><?php echo showImage($vo1['smPic'],56,56); ?></a></div>
                                    <div class="c-info">
                                        <div class="o-info-lm">
                                            <a href="<?php echo url('index/goods/index',array('id' => $vo1['goodsId'])); ?>" class="info-name" target="_blank" title="<?php echo $vo1['goodsName']; ?>"><?php echo $vo1['goodsName']; ?></a>
                                        </div>
                                        <div class="fl">
                            ...
                            <div class="c-handle" id="ss_msg_1">
                                <a href="user.php?act=order_detail&amp;order_id=1" class="sc-btn">订单详情</a>
                                <a href="javascript:get_order_delete_restore('delete', 1);" class="sc-btn">删除订单</a>
                                <a href="user.php?act=cancel_order&amp;order_id=1" onclick="if (!confirm('您确认要取消该订单吗？取消后此订单将视为无效订单')) return false;" class="sc-btn">取消订单</a>
