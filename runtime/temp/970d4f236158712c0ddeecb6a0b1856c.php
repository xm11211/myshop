                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="adminName" data-bv-field="adminName"><i class="form-control-feedback" data-bv-icon-for="adminName" style="display: none;"></i>
                                            ...
                                            <?php if(is_array($agData) || $agData instanceof \think\Collection || $agData instanceof \think\Paginator): $i = 0; $__LIST__ = $agData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <?php if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                                                        <td class="col-lg-3">
                                                            <label>
                                                                <input type="checkbox" name="agId[]" value="<?php echo $vo1['id']; ?>" class="colored-blue">
