<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/www.xxsucai.com/public/../application/index/view/flow/order3.html";i:1540950835;s:70:"/www/wwwroot/www.xxsucai.com/application/index/view/common/footer.html";i:1540963003;}*/ ?>
        ...
        <div class="payOrder-warp" id="pay_main">
            <div class="payOrder-desc">
                <div class="pay-top">
                    ...
                    <div class="pay-total">
                        <span>应付总额：</span>
                        <div class="pay-price">￥<?php echo $orderData['orderTotalPrice']; ?></div>
                    </div>
                </div>
                <div class="pay-txt">
                    <p>订单号：<em id="nku"><?php echo $orderData['outTradeNo']; ?></em></p>
                    <p>您选定的支付方式为：<span id="paymode">
                        <?php if($orderData['payment'] == 1): ?>支付宝<?php else: ?>微信<?php endif; ?>
                    </span></p>
                    <p>配送方式: <span id="express"><?php echo $orderData['distribution']; ?></span></p>
                </div>
                <div class="o-list">
                    <div class="o-list-info">
                        <span id="shdz">寄送至：<?php echo $orderData['province']; ?> <?php echo $orderData['city']; ?>  <?php echo $orderData['county']; ?>  &nbsp;&nbsp;<?php echo $orderData['address']; ?></span>
                        <span id="shr">收货人：<?php echo $orderData['name']; ?></span>
                        <span id="mobile"><?php echo $orderData['phone']; ?></span>
                    </div>
                </div>
                <?php echo $payBtn; ?>
            </div>
            ...
            <!--<div class="payOrder-mode">-->
                <!--<div class="payOrder-list">-->
                    ...
                    <!--<div class="p-mode-list">-->
                        <!--<div class="p-mode-item alipay" order_sn="2018062519461364588" flag="alipay">      <div class="alipay" style="text-align:center"><input type="button" onclick="window.open('https://openapi.alipay.com/gateway.do?app_id=2016061401515111&biz_content=%7B%22out_trade_no%22%3A%2260000000000000080000000000350330%22%2C%22product_code%22%3A%22FAST_INSTANT_TRADE_PAY%22%2C%22total_amount%22%3A%223503.3%22%2C%22subject%22%3A%222018062519461364588%22%2C%22body%22%3A%222018062519461364588%22%2C%22passback_params%22%3A%228%22%2C%22goods_type%22%3A%221%22%2C%22timeout_express%22%3A%221440m%22%7D&charset=UTF-8&format=JSON&method=alipay.trade.page.pay&notify_url=https%3A%2F%2Ftest.dscmall.cn%2Fapi%2Fnotify%2Falipay.php&return_url=https%3A%2F%2Ftest.dscmall.cn%2Frespond.php%3Fcode%3Dalipay&sign_type=RSA2&timestamp=2018-06-25+19%3A45%3A29&version=1.0&sign=IEonXJ3MS4pGAWWc%2BmVNdywbXB68e5dFyxtnrpuXEtRHrKmc0addM2DdlKr4G%2BPQ6QKprY62ddsE0BoWNDaZeTD%2BNpmBVLlv7udxflVrspLZYS%2FFTkC1Zx9BOLbtmRsP4E9rF7L2KcCCtmbiKew4Am8M4kJnB67b0EhJDoH90hZtM3xAeJBlShnqp2FrzCGtwME67jh8k3YGwEujglhiLzDNds8VeLOwvDHjt5xas%2FB7fedmhJNV0yUlmFb83z%2BkA4JwkhyRBilgCtK%2BKyUSPZ4n8Z%2BlJPVN3UqyfRPVe%2FXqVcEO1IIENHgmRF4%2Be7sCbWYyUdjhqcM7SuDdO6wkTw%3D%3D')" value="支付宝支付" /></div></div>-->
                    <!--</div>-->
                <!--</div>-->
            <!--</div>-->
        </div>
