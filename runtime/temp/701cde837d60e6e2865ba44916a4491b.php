                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $adminData['adminName']; ?>" class="form-control" name="adminName" data-bv-field="adminName"><i class="form-control-feedback" data-bv-icon-for="adminName" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="adminName" data-bv-result="NOT_VALIDATED" style="display: none;">昵称不能为空！</small></div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <small class="help-block" data-bv-validator="stringLength" data-bv-for="password" data-bv-result="NOT_VALIDATED" style="display: none;">密码不要超过40位字符！</small></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <?php if($adminData['pic'] != ''): ?>
                                    <div class="col-lg-2 col-md-2 col-sm-2" >
                                        <?php echo showImage($adminData['pic'],$adminData['pic'],65,65); ?>
                                    </div>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="flip-scroll col-lg-8">
                                        <table class="table table-bordered table-striped table-condensed flip-content">
                                            <tbody>
                                            <?php if(is_array($agData) || $agData instanceof \think\Collection || $agData instanceof \think\Paginator): $i = 0; $__LIST__ = $agData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                ...
                                                <td class="col-lg-3">
                                                    <label>
                                                        <input type="checkbox" <?php if(in_array(($vo1['id']), is_array($agIds)?$agIds:explode(',',$agIds))): ?>checked<?php endif; ?> name="agId[]" value="<?php echo $vo1['id']; ?>" class="colored-blue">
