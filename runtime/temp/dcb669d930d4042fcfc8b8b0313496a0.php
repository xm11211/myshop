<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/article/edit.html";i:1518732886;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="cateId" style="width: 100%;">
                                            <?php if(is_array($cateData) || $cateData instanceof \think\Collection || $cateData instanceof \think\Paginator): $i = 0; $__LIST__ = $cateData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id'] == 4 OR $vo['id'] == 5): else: ?>
                                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $artData['cateId']): ?>selected="selected"<?php endif; ?>><?php echo str_repeat('-',$vo['level'] * 4); ?><?php echo $vo['cateName']; ?></option>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $artData['title']; ?>" class="form-control" name="title" data-bv-field="title"><i class="form-control-feedback" data-bv-icon-for="title" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $artData['keywords']; ?>" class="form-control" name="keywords" placeholder="多个关键词用英文逗号分隔" data-bv-field="keywords"><i class="form-control-feedback" data-bv-icon-for="keywords" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $artData['author']; ?>" class="form-control" name="author" data-bv-field="author"><i class="form-control-feedback" data-bv-icon-for="author" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $artData['email']; ?>" class="form-control" name="email" data-bv-field="email"><i class="form-control-feedback" data-bv-icon-for="email" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $artData['url']; ?>" class="form-control" name="url" data-bv-field="url"><i class="form-control-feedback" data-bv-icon-for="url" style="display: none;"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($artData['thumb'] != ''): ?>
                                    <div class="col-lg-2 col-md-2 col-sm-2" >
                                        <?php echo showImage($artData['thumb'],$artData['thumb'],65,65); ?>
                                    </div>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="showTop" value="1" <?php if($artData['showTop'] == 1): ?>checked<?php endif; ?> type="checkbox">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="showStatus" value="1" <?php if($artData['showStatus'] == 1): ?>checked<?php endif; ?> type="checkbox">
                                            <span class="text"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea name="desc" style="resize: none;height:200px;" class="form-control" data-bv-field="desc"><?php echo $artData['desc']; ?></textarea><i class="form-control-feedback" data-bv-icon-for="desc" style="display: none;"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea name="content" id="details" style="resize: none;"><?php echo $artData['content']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
