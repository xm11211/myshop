    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header  with-footer">
                <span class="widget-caption"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">图片列表</font></font></span>
            ...
            <div class="widget-body">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tbody>
                        <?php if(is_array($imageArr) || $imageArr instanceof \think\Collection || $imageArr instanceof \think\Paginator): $i = 0; $__LIST__ = $imageArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td class="sorting_disabled" rowspan="1" colspan="1" aria-label="">
                                <label>
                                    <input type="checkbox" name="delPic" value="<?php echo $vo; ?>">
                                    <span class="text"></span>
                                </label>
                            </td>
                            <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                <?php if($vo == ''): ?>
                                    暂无
                                    <?php else: ?>
                                <img src="<?php echo $vo; ?>" height="56">
                                <?php endif; ?>
                            </font></font></td>
                            <td>
                                <button value="<?php echo $vo; ?>" flag="del" name="bootbox-confirm" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>删除</button>
                            </td>
                        </tr>
...
<script>
   $(function () {
       ...
       //批量点击
       clickBatch('#thCheck','input:checkbox[name=delPic]');
       //批量删除
       delBat('#delInBat','input:checkbox[name=delPic]:checked','#secMsg',
           delUrl);
       $("#sidebar-menu a[href*=picture" + "\\/"+ "lst]").parent().addClass('active').parent().parent().addClass('open');
   });
</script>
