<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/wwwroot/www.xxsucai.com/public/../application/index/view/flow/cart.html";i:1540950757;s:70:"/www/wwwroot/www.xxsucai.com/application/index/view/common/footer.html";i:1540963003;}*/ ?>
<!doctype html>
<html>
<head>
...
var cartGoodsAmount = "<?php echo url('index/flow/cartGoodsAmount'); ?>";
var updateToCart = "<?php echo url('index/flow/updateToCart'); ?>";
var getLoginDialog = "<?php echo url('index/flow/getLoginDialog'); ?>";
</script><link rel="stylesheet" type="text/css" href="/static/Home/css/perfect-scrollbar.min.css" />
</head>
...
<div class="header header-cart">
    <div class="w w1200">
        <div class="logo">
            ...
            <div class="tit">购物车（<em ectype="cartNum"><?php echo $goodsNum; ?></em>）</div>
        </div>
...
<div class="area-warp" id="area_list">
    ...
    <input type="hidden" value="" id="merchantId" name="merchantId">
        ...
        <input type="hidden" value="<?php echo \think\Request::instance()->session('uid'); ?>" id="user_id" name="user_id">
...
<div class="cart-tbody" ectype="cartTboy">
                            ...
                            <div class="item-form">
                                ...
                                <div class="cell s-goods">
                                    <div class="goods-item">
                                        <div class="p-img">
                                        <a href="#" target="_blank"><?php echo showImage($vo['mdPic'],70,70); ?></a>
                                        </div>
                                        <div class="item-msg">
                                                    <a href="#" target="_blank"><?php echo $vo['goodsName']; ?></a>
                                                    <div class="gds-types">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cell s-props">
                                       <?php echo $vo['goodsAttrStr']; ?>
                                    &nbsp;</div>
                                <div class="cell s-price">
                                    <strong id="goods_price_<?php echo $key; ?>"><em>¥</em><?php echo $vo['memberPrice']; ?></strong>
                                                        </div>
                                <div class="cell s-quantity">
                                    <div class="amount-warp">
                                                <input type="text" value="<?php echo $vo['goodsNumber']; ?>" name="goods_number[<?php echo $key; ?>]" id="goods_number_<?php echo $key; ?>"
                                                       onchange="change_goods_number('<?php echo $key; ?>', this.value, 2, 16)" class="text buy-num" ectype="number" defaultnumber="1">
                                            <div class="a-btn">
                                                    <a href="#" onclick="changenum('<?php echo $key; ?>', 1, 2, 16,11,this)"  class="btn-add"><i class="iconfont icon-up"></i></a>
                                            <a href="#" onclick="changenum('<?php echo $key; ?>', -1, 2, 16,11,this)" class="btn-reduce <?php if($vo['goodsNumber'] == 1): ?>btn-disabled<?php endif; ?>"><i class="iconfont icon-down"></i></a>
                                                </div>
                                        </div>
                                    <div class="tc ftx-03">有货</div>
                    </div>
                                <div class="cell s-sum">
                                    <strong id="goods_subtotal_<?php echo $key; ?>"><font id="_<?php echo $key; ?>_subtotal"><em>¥</em><?php echo $vo['totalPrice']; ?></font></strong>
                                    <div class="cuttip hide">
                                        <span class="tit">优惠</span>
                                        <span class="price" id="discount_amount_<?php echo $key; ?>"><em>¥</em>0.00</span>
                                    </div>
                                                        </div>
                                <div class="cell s-action">
                                    <a href="#" id="remove_<?php echo $key; ?>" ectype="cartOperation" data-value='{"divId":"cart_remove","url":"<?php echo url('index/flow/cartGoodsRemove',array('recid' => $key)); ?>","cancelUrl":"flow.php?step=drop_to_collect&amp;id=<?php echo $key; ?>","recid":"<?php echo $key; ?>","title":"删除"}' class="cart-remove">删除</a>
                                    <a href="#" id="store_<?php echo $key; ?>" ectype="cartOperation" data-value='{"divId":"cart_collect","url":"flow.php?step=drop_to_collect&amp;id=<?php echo $key; ?>","recid":"<?php echo $key; ?>","title":"关注"}' class="cart-store">收藏</a>
                                </div>
                            </div>
                    </div>
                </div>
    ...
    <div class="cart-checkbox cart-all-checkbox" ectype="ckList">
	    ...
	    <div class="operation">
        <a href="#" class="cart-remove-batch" data-dialog="remove_collect_dialog" data-divid="cart-remove-batch" data-removeurl="<?php echo url('index/flow/cartGoodsRemove'); ?>" data-collecturl="ajax_dialog.php?act=drop_to_collect" data-title="删除">删除选中的商品</a>
    ...
    <div class="toolbar-right">
        <div class="comm-right">
            <div class="btn-area">
                <form name="formCart" method="post" action="<?php echo url('index/flow/cart'); ?>" onsubmit="return get_toCart();">
                    <input name="goPay" type="submit" class="submit-btn" value="去支付"  <?php if(!\think\Request::instance()->session('uid')): ?>id="go_pay"<?php endif; ?> data-url="<?php echo url('index/flow/cart'); ?>"/>
...
<li class="opacity_img">
    <div class="p-img"><a href="#" target="_blank"><img src="/static/Home/img/0_thumb_G_1489109633806.jpg" width="190" height="190"></a></div>
...
<li class="opacity_img">
    <div class="p-img"><a href="#" target="_blank"><img src="/static/Home/img/0_thumb_G_1489108999364.jpg" width="190" height="190"></a></div>
...
<li class="opacity_img">
    <div class="p-img"><a href="#" target="_blank"><img src="/static/Home/img/0_thumb_G_1489102753231.jpg" width="190" height="190"></a></div>
    <div class="p-price"><em>¥</em>300.00</div>
    <div class="p-name"><a href="#" target="_blank">新款韩版chic学生宽松短款外套上衣字母长袖连帽套头卫衣女潮</a></div>
    <div class="p-num">已售<em>2</em>件</div>
</li>
<li class="opacity_img">
    <div class="p-img"><a href="#" target="_blank"><img src="/static/Home/img/0_thumb_G_1489109337889.jpg" width="190" height="190"></a></div>
...
<li class="opacity_img">
    <div class="p-img"><a href="#" target="_blank"><img src="/static/Home/img/0_thumb_G_1489109282145.jpg" width="190" height="190"></a></div>
...
<script type="text/javascript" src="/static/Home/js/checkAll.js"></script>
<script type="text/javascript">
        ...
        function change_goods_number(rec_id, goods_number, warehouse_id, area_id, cValue, favourable_id){
            ...
            // Ajax.call(updateCart, 'rec_id=' + rec_id + '&sel_id=' + str + '&sel_flag=' + 'cart_sel_flag' +'&goods_number=' + goods_number +'&cValue=' + cValue +'&warehouse_id=' + warehouse_id +'&area_id=' + area_id +'&favourable_id=' + favourable_id, change_goods_number_response, 'POST','JSON');
            Ajax.call(updateToCart, 'rec_id=' + rec_id  +'&goods_number=' + goods_number +'&cValue=' + cValue, change_goods_number_response, 'POST','JSON');
        }
