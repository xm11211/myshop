    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="widget  radius-bordered">
            <div class="widget-header bg-themeprimary">
                <span class="widget-caption">商品品牌</span>
            </div>
                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $brandData['brandName']; ?>" class="form-control" name="brandName" data-bv-field="brandName"><i class="form-control-feedback" data-bv-icon-for="brandName" style="display: none;"></i>
                                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="brandName" data-bv-result="NOT_VALIDATED" style="display: none;">品牌名称不能为空！</small></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right">是否显示</label>
                                    <div class="col-xs-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="status" value="1" <?php if($brandData['status'] == 1): ?>checked<?php endif; ?> type="checkbox">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" value="<?php echo $brandData['url']; ?>" class="form-control" name="url" data-bv-field="url"><i class="form-control-feedback" data-bv-icon-for="url" style="display: none;"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($brandData['pic'] != ''): ?>
                                    <div class="col-lg-2 col-md-2 col-sm-2" >
                                        <?php echo showImage($brandData['pic'],65,65); ?>
                                    </div>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" style="resize: none;height: 200px;" name="desc" data-bv-field="desc"><?php echo $brandData['desc']; ?></textarea><i class="form-control-feedback" data-bv-icon-for="desc" style="display: none;"></i>
...
<script>
    $(document).ready(function () {
        ...
        $("#sidebar-menu a[href*=brand" + "\\/"+ "lst]").parent().addClass('active').parent().parent().addClass('open');
    });
</script>
