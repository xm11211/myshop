<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"F:\day\myshop\public/../application/index\view\category\index.html";i:1541818799;s:55:"F:\day\myshop\application\index\view\common\header.html";i:1541134761;s:54:"F:\day\myshop\application\index\view\common\right.html";i:1519852424;s:55:"F:\day\myshop\application\index\view\common\footer.html";i:1540963004;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <div class="s-l-wrap brand_img attr_list">
                    ...
                    <div class="s-l-value attr_son">
                        <div class="price_auto fl">
                            <div class="price_range"><a <?php if(!input('brandId')): ?>class="btn sc-redBg-btn"<?php endif; ?>
                                href="<?php
                                    $urlArr = [];
                                    $urlArr['id'] = $categoryId;
                                    input('price') ? $urlArr['price'] = input('price') : '';
                                    if($filters) {
                                        echo url('index/category/index',$urlArr,'').'?filterAttr='.$filters;
                                    }else {
                                        echo url('index/category/index',$urlArr,'');
                                    }
                                ?>">不限</a></div>
                            ...
                            <div class="price_range"><a <?php if(input('brandId') == $vo['id']): ?>class="btn sc-redBg-btn"<?php endif; ?>
                                href="<?php
                                $urlArr = [];
                                 $urlArr['id'] = $categoryId;
                                 $urlArr['brandId'] = $vo['id'];
                                 input('price') ? $urlArr['price'] = input('price') : '';
                                        if($filters) {
                                            echo url('index/category/index',$urlArr,'').'?filterAttr='.$filters;
                                        }else {
                    ...
                    <div class="s-l-value attr_son">
                        <div class="price_auto fl">
                            <div class="price_range">
                                <a <?php if(!input('price')): ?>class="btn sc-redBg-btn"<?php endif; ?>
                                href="<?php
                                 $urlArr = [];
                                 $urlArr['id'] = $categoryId;
                                 input('brandId') ? $urlArr['brandId'] = input('brandId') : '';
                                if($filters) {
                                    echo url('index/category/index',$urlArr,'').'?filterAttr='.$filters;
                                }else {
                                    echo url('index/category/index',$urlArr,'');
                            ...
                            <div class="price_range">
                                <a <?php if(input('price') == $vo): ?>class="btn sc-redBg-btn"<?php endif; ?>
                                href="<?php
                                 $urlArr = [];
                                 $urlArr['id'] = $categoryId;
                                 $urlArr['price'] = $vo;
...
<button class="price_ok price_class">确定</button>
            ...
            if($filterAttr) {
                $attrArr = explode('.',$filterAttr);

            }else {
                $attrArr = array_fill(0,$attrCount,0);
            }
            foreach($attrData as $k => $v):?>
                <li class="s-line">
                    <dl class="s-l-wrap">
                        <div class="s-l-tit filter_attr_name"><?=$v['attrName']?>：</div>
                        <div class="s-l-value attr_son">
                            <div class="price_auto fl">
                                <?php
                                    $tempAttrArr = $attrArr;
                                    ...
                                    if($tempAttrArr[$k] == '0') {
                                        $bool1 = true;
                                    }else if($tempAttrArr[$k] == $str1) {
                                        $bool1 = true;
                                    }else {
                                        $bool1 = false;
                                    }
                                    $tempAttrArr[$k] = $str1;
                                    $attrStr = implode('.',$tempAttrArr);
                                ?>
                                <div class="price_range"><a <?php if($bool1):?>class="btn sc-redBg-btn"<?php endif; ?>
                                    href="<?php
                                            $urlArr = [];
                                            $urlArr['id'] = $categoryId;
                                            input('price') ? $urlArr['price'] = input('price') : '';
                                            input('brandId') ? $urlArr['brandId'] = input('brandId') : '';
                                            echo url('index/category/index',$urlArr,'').'?filterAttr='.$attrStr;
                                            ?>
                                    ">不限</a></div>
                                <?php foreach($v['attrValues'] as $k1 => $v1):
                                    $tempAttrArr = $attrArr;
                                    $str2 = $v1.'-'.$v['attrId'];
                                    if($tempAttrArr[$k] === $str2) {
                                        $bool2 = true;
                                    }else {
                                        $bool2 = false;
                                    }
                                    ...
                                    $attrStr = implode('.',$tempAttrArr);
                                ?>
                                    <div class="price_range"><a <?php if($bool2):?>class="btn sc-redBg-btn"<?php endif; ?>
                                        href="<?php
                                                $urlArr = [];
                                                $urlArr['id'] = $categoryId;
                                                input('price') ? $urlArr['price'] = input('price') : '';
    ...
    <div class="goods-list" ectype="gMain">
                <div class="gl-warp gl-warp-large">
        	            <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);" class="goodslistForm" data-state="0">
                            <ul>
                                <?php if($goodsRes): if(is_array($goodsRes) || $goodsRes instanceof \think\Collection || $goodsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <li class="gl-item">
                                    <div class="gl-i-wrap">
