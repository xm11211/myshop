<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"K:\AMP\day\myshop\public/../application/member\view\order\orderList.html";i:1545285673;s:59:"K:\AMP\day\myshop\application\index\view\common\header.html";i:1544835140;s:58:"K:\AMP\day\myshop\application\member\view\common\left.html";i:1545287241;s:59:"K:\AMP\day\myshop\application\index\view\common\footer.html";i:1544835140;}*/ ?>
<!doctype html>
<html>
<head>
                    ...
                    <div class="categorys-item" ectype="cateItem" data-id="<?php echo $vo['id']; ?>" data-eveval="0">
                        <div class="item item-content">
                            ...
                            <div class="categorys-title">
                                <strong>
                                    <a href="<?php echo url('index/category/index',['id' => $vo['id']]); ?>" target="_blank"><?php echo $vo['cateName']; ?></a>
                                </strong>
                                <span>
                                    ...
                                    <a href="<?php echo url('index/category/index',['id' => $vo['id']]); ?>" target="_blank"><?php echo $vo1['cateName']; ?></a>
                                    <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                 </span>
                            </div>
                        </div>
...
<div class="user-content clearfix">
    ...
    <div class="user-mod user-perinfo">
        <div class="profile clearfix">
            <div class="avatar">
                <a href="/user/<?php echo $userData['id']; ?>.html" class="u-pic">
                    <?php if($userData['avator'] != ''): ?><?php echo showImage($userData['avator']); else: ?>
                    <img src="/static/Home/img/touxiang.jpg" alt="">
                    <?php endif; ?>
            ...
            <div class="name">
                ...
                <?php switch($levelName): case "注册会员": ?><div class="user-rank user-rank-1">注册会员</div><?php break; case "中级会员": ?><div class="user-rank user-rank-2">中级会员</div><?php break; case "高级会员": ?><div class="user-rank user-rank-3">高级会员</div><?php break; endswitch; ?>
        ...
        <div class="account">
            <div class="item clearfix">
                ...
                <div class="item-main">
                    <b class="integrity"><em style="width: <?php echo $progress; ?>%;"></em></b><span><?php echo $progress; ?>%</span>
                </div>
            </div>
            <div class="item clearfix">
                <div class="item-name">账户安全：</div>
                <div class="item-main safe">
                    <?php if($userData['eChecked'] == 1): ?>
                    ...
                    <?php endif; if($userData['password'] != ''): ?>
                    <a href="#" class="iconfont icon-password active"><span class="tip">密码已设置</span></a>
                    <?php else: ?>
                    <a href="#" class="iconfont icon-password"><span class="tip">密码未设置</span></a>
                    <?php endif; if($userData['tChecked'] == 1): ?>
    ...
    <div class="user-mod">
        <div class="side-menu">
            <dl>
                ...
                <dd>
                    <p <?php if($currOpt == 'order'): ?>class="current"<?php endif; ?>><a href="<?php echo url('member/order/orderList'); ?>" target="_self">我的订单</a></p>
                    <p <?php if($currOpt == 'address'): ?>class="current"<?php endif; ?>><a href="<?php echo url('member/address/address'); ?>" target="_self">收货地址</a></p>
                </dd>
            </dl>
            <dl>
                <dt><i class="square"></i><span>会员中心</span></dt>
                <dd>
                    <p <?php if($currOpt == 'userInfo'): ?>class="current"<?php endif; ?>><a href="<?php echo url('member/user/userInfo'); ?>" target="_self">用户信息</a></p>
                </dd>
            </dl>
        </div></div>
</div>
    ...
    <div class="user-main" ectype="userMain" data-action="noDefault">
        ...
        <div class="user-mod" style="min-height: 1018px;">
            <div class="user-title">
                <h2>我的订单</h2>
                <ul class="tabs">
                    <li <?php if($orderStatus == 1): ?>class="active"<?php endif; ?>><a href="<?php echo url('member/order/orderList',array('orderStatus' => 1)); ?>">全部订单(<?php echo $ordersNum; ?>)</a></li>
                    <li class="user-count3 <?php if($orderStatus == 2): ?>active<?php endif; ?>" >
                        <a href="<?php echo url('member/order/orderList',array('orderStatus' => 2)); ?>">待确认(<?php echo $notConfirmOrdersNum; ?>)</a>
                        <input name="to_unconfirmed" id="to_unconfirmed" type="hidden" value="0">
                    </li>
                    <li class="user-count1 <?php if($orderStatus == 3): ?>active<?php endif; ?>">
                        <a href="<?php echo url('member/order/orderList',array('orderStatus' => 3)); ?>">待付款(<?php echo $notPayOrdersNum; ?>)</a>
                        <input name="toBe_pay" id="payId" type="hidden" value="100">
                    </li>
                    <li class="user-count2 <?php if($orderStatus == 4): ?>active<?php endif; ?>">
                        <a href="<?php echo url('member/order/orderList',array('orderStatus' => 4)); ?>">待收货(<?php echo $notReceiveOrdersNum; ?>)</a>
                        <input name="to_confirm_order" id="to_confirm_order" type="hidden" value="103">
                    </li>
                    <li class="user-count4 <?php if($orderStatus == 5): ?>active<?php endif; ?>">
                        <a href="<?php echo url('member/order/orderList',array('orderStatus' => 5)); ?>">已完成(<?php echo $finishOrdersNum; ?>)</a>
            ...
            <div class="user-list-title clearfix">
                <div class="user-list-filter">
                    <div id="order_status" class="imitate_select w120 mr10">
                        <div class="cite"><span>全部状态</span><i class="iconfont icon-down"></i></div>
                        <ul>
                            <li id="order_status_-1"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="-1" data-value="-1">全部状态</a></li>
                            <li id="order_status_0"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="0" data-value="0">待确认</a></li>
                            <li id="order_status_100"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="100" data-value="100">待付款</a></li>
                            <li id="order_status_101"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="101" data-value="101">待发货</a></li>
                            <li id="order_status_103"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="103" data-value="103">待确认收货</a></li>
                            <li id="order_status_102"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="102" data-value="102">已完成</a></li>
                            <li id="order_status_1"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="1" data-value="1">付款中</a></li>
                            <li id="order_status_2"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="2" data-value="2">取消</a></li>
                            <li id="order_status_3"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="3" data-value="3">无效</a></li>
                            <li id="order_status_4"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="4" data-value="4">退货</a></li>
                            <li id="order_status_6"><a href="javascript:void(0);" data-idtxt="status_list" data-action="order_list" data-type="order_status" data-id="6" data-value="6">部分发货</a></li>
                        </ul>
                        <input name="order_status_list" type="hidden" value="-1" id="order_status_val">
                    </div>
                    <div id="dateTime" class="imitate_select w120">
                        <div class="cite"><span>全部时间</span><i class="iconfont icon-down"></i></div>
                        <ul>
                            <li id="time_allDate"><a href="javascript:void(0);" data-idtxt="submitDate" data-action="order_list" data-type="dateTime" data-id="allDate" data-value="allDate">全部时间</a></li>
                            <li id="time_today"><a href="javascript:void(0);" data-idtxt="submitDate" data-action="order_list" data-type="dateTime" data-id="today" data-value="today">今天</a></li>
                            <li id="time_three_today"><a href="javascript:void(0);" data-idtxt="submitDate" data-action="order_list" data-type="dateTime" data-id="three_today" data-value="three_today">3天内</a></li>
                            <li id="time_aweek"><a href="javascript:void(0);" data-idtxt="submitDate" data-action="order_list" data-type="dateTime" data-id="aweek" data-value="aweek">一周内</a></li>
                            <li id="time_thismonth"><a href="javascript:void(0);" data-idtxt="submitDate" data-action="order_list" data-type="dateTime" data-id="thismonth" data-value="thismonth">一月内</a></li>
                        </ul>
                        <input name="order_submitDate" type="hidden" value="allDate" id="dateTime_val">
                    </div>
                </div>
                <div class="user-list-search">
                    <input type="text" id="ip_keyword" class="text" onkeydown="javascript:if(event.keyCode==13) get_OrderSearch('ip_keyword');" onblur="if (this.value=='') this.value=this.defaultValue; this.style.color='#999'" onfocus="if (this.value==this.defaultValue)this.value='';this.style.color='#666'" placeholder="输入商品名称或者订单号搜索" name="" style="color:#999;">
                    <button type="button" onclick="get_OrderSearch('ip_keyword', 'order_list', 'text')"><i class="iconfont icon-search"></i></button>
                </div>
            </div>
            <div id="user_order_list">
                <div class="user-order-list user-order-list-special">
                    <?php if($orders): if(is_array($showOrders) || $showOrders instanceof \think\Collection || $showOrders instanceof \think\Paginator): $i = 0; $__LIST__ = $showOrders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <dl class="item">
                        <dt class="item-t item-t-qb">
                            <div class="t-statu">
                                <div class="t-statu-name" id="ss_received_1">
                                    <?php switch($vo['orderStatus']): case "0": ?>未确认,<?php break; case "1": ?>已确认,<?php break; case "2": ?>申请退款,<?php break; case "3": ?>退款成功,<?php break; endswitch; switch($vo['payStatus']): case "0": ?>未支付,<?php break; case "1": ?>已支付,<?php break; endswitch; switch($vo['postStatus']): case "0": ?>未发货<?php break; case "1": ?>已发货<?php break; case "2": ?>已收货<?php break; endswitch; ?>
                                </div>
                            </div>
                            <div class="t-info">
                                <span class="info-item">订单号：<?php echo $vo['outTradeNo']; ?></span>
                                <span class="info-item"> <?php echo date("y-m-d",$vo['orderTime']); ?></span>
                                <span class="info-item"> <?php echo $vo['name']; ?></span>
                            </div>
                            <div class="t-price"><em>¥</em><?php echo $vo['orderTotalPrice']; ?></div>
                        </dt>

                        <dd class="item-c">
                            <div class="c-left">
                                <?php if(is_array($vo['orderGoods']) || $vo['orderGoods'] instanceof \think\Collection || $vo['orderGoods'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['orderGoods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                                <div class="c-goods" ectype="c-goods">
                                    <div class="c-img"><a href="/goods/<?php echo $vo1['goodsId']; ?>.html"><?php echo showImage($vo1['smPic'],56,56); ?></a></div>
                                    <div class="c-info">
                                        <div class="o-info-lm">
                                            <a href="/goods/<?php echo $vo1['goodsId']; ?>.html" class="info-name" target="_blank" title="<?php echo $vo1['goodsName']; ?>"><?php echo $vo1['goodsName']; ?></a>
                                        </div>
                                        <div class="fl">
                                            <div class="info-price mr10" style="width: auto;"><b><em>¥</em><?php echo $vo1['goodsMemberPrice']; ?></b><i>×</i><span><?php echo $vo1['goodsNum']; ?></span></div>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                            <div class="c-handle" id="ss_msg_1">
                                <a href="<?php echo url('member/order/orderDetail',array('id' => $vo['id'])); ?>" class="sc-btn">订单详情</a>
                                <a onclick="if(!confirm('您确定要删除该订单吗？')) return false;" href="<?php echo url('member/order/orderDelete',array('id' => $vo['id'])); ?>" class="sc-btn">删除订单</a>
                            </div>
                        </dd>
                    </dl>
                ...
                <div class="pages pages_warp">
                    <?php if($orders): ?>
                    <?php echo $orders->render(); endif; ?>
                    <!--<div class="item prev">-->
                        <!--<a href="javascript:user_order_gotoPage(0, 65, 0, 0);"><i class="iconfont icon-left"></i></a>-->
                    <!--</div>-->
                    <!--<div class="item cur">-->
                        <!--<a spellcheck="false">1</a>-->
                    <!--</div> -->
                    <!--<div class="item next">-->
                        <!--<a href="javascript:user_order_gotoPage(1, 65, 0, 0);"><i class="iconfont icon-right"></i></a>-->
                    <!--</div> -->
                </div>
...
<script type="text/javascript" src="/static/Home/js/jquery.SuperSlide.2.1.1.js"></script><script type="text/javascript" src="/static/Home/js/jquery.yomi.js"></script><script type="text/javascript" src="/static/Home/js/common.js"></script><script type="text/javascript" src="/static/Home/js/jquery.validation.min.js"></script><script type="text/javascript" src="/static/Home/js/jquery.nyroModal.js"></script><script type="text/javascript" src="/static/Home/js/perfect-scrollbar.min.js"></script><script type="text/javascript" src="/static/Home/js/ZeroClipboard.js"></script><script type="text/javascript" src="/static/Home/js/dsc-common.js"></script>
