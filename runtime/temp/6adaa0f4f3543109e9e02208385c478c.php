                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" name="pid">
                                            ...
                                            <?php if(empty($allCates) || (($allCates instanceof \think\Collection || $allCates instanceof \think\Paginator ) && $allCates->isEmpty())): else: if(is_array($allCates) || $allCates instanceof \think\Collection || $allCates instanceof \think\Paginator): $i = 0; $__LIST__ = $allCates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="keywords" placeholder="多个关键词用逗号分隔" data-bv-field="keywords"><i class="form-control-feedback" data-bv-icon-for="keywords" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="psNum" data-bv-field="psNum"><i class="form-control-feedback" data-bv-icon-for="psNum" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea name="desc" style="resize: none;height:100px;" class="form-control" data-bv-field="desc"></textarea><i class="form-control-feedback" data-bv-icon-for="desc" style="display: none;"></i>
