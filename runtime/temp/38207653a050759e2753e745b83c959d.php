<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/www/wwwroot/www.xxsucai.com/public/../application/admin/view/goods/edit.html";i:1539145222;s:63:"/www/wwwroot/www.xxsucai.com/application/admin/view/layout.html";i:1515386558;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/header.html";i:1535520342;s:70:"/www/wwwroot/www.xxsucai.com/application/admin/view/Common/footer.html";i:1515571090;}*/ ?>
<!DOCTYPE html>
                    ...
                    <form id="adminForm" method="post" enctype="multipart/form-data" class="form-horizontal bv-form" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
                        ...
                        <div class="tab-content tabs-flat">
                            <div class="tab-pane active" id="info-tab">
                                ...
                                <div class="form-group has-feedback" id="cate">
                                    ...
                                    <div class="col-lg-3">
                                        <select class="form-control" name="cateId">
                                            ...
                                            <option value="<?php echo $vo['id']; ?>" <?php if($goodsData['cateId'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo str_repeat('-',$vo['level'] * 4); ?><?php echo $vo['cateName']; ?></option>
                                ...
                                <?php if(empty($ecData) || (($ecData instanceof \think\Collection || $ecData instanceof \think\Paginator ) && $ecData->isEmpty())): else: if(is_array($ecData) || $ecData instanceof \think\Collection || $ecData instanceof \think\Paginator): $k = 0; $__LIST__ = $ecData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                                <div class="form-group has-feedback" name="cate">
                                    ...
                                    <div class="col-lg-3">
                                        <select class="form-control" name="extCat[]">
                                            <option value="0" selected="selected">请选择</option>
                                            <?php if(is_array($cateData) || $cateData instanceof \think\Collection || $cateData instanceof \think\Paginator): $i = 0; $__LIST__ = $cateData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo $vo1['id']; ?>" <?php if($vo['catId'] == $vo1['id']): ?>selected="selected"<?php endif; ?>><?php echo str_repeat('-',$vo1['level'] * 4); ?><?php echo $vo1['cateName']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="goodsName" value="<?php echo $goodsData['goodsName']; ?>" data-bv-field="goodsName"><i class="form-control-feedback" data-bv-icon-for="goodsName" style="display: none;"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($goodsData['smPic'] != ''): ?>
                                    <div class="col-lg-2 col-md-2 col-sm-2" >
                                        <?php echo showImage($goodsData['smPic'],$goodsData['smPic'],65,65); ?>
                                    </div>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="marketPrice" value="<?php echo $goodsData['marketPrice']; ?>" data-bv-field="marketPrice"><i class="form-control-feedback" data-bv-icon-for="marketPrice" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="shopPrice" value="<?php echo $goodsData['shopPrice']; ?>" data-bv-field="shopPrice"><i class="form-control-feedback" data-bv-icon-for="shopPrice" style="display: none;"></i>
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-2" style="padding-right:0;">
                                        <input type="text" class="form-control" name="weight" value="<?php echo $goodsData['weight']; ?>" data-bv-field="weight"><i class="form-control-feedback" data-bv-icon-for="weight" style="display: none;"></i>
                                    ...
                                    <div class="col-lg-2">
                                        <select class="form-control" name="unit">
                                            <option value="kg" <?php if($goodsData['unit'] == 'kg'): ?>selected="selected"<?php endif; ?>>kg</option>
                                            <option value="g" <?php if($goodsData['unit'] == 'g'): ?>selected="selected"<?php endif; ?>>g</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-4">
                                        <label>
                                            <input class="checkbox-slider slider-icon yesno" name="onSale" value="1" <?php if($goodsData['onSale'] == 1): ?>checked<?php endif; ?> type="checkbox">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="checkbox col-lg-2">
                                            <label>
                                                <input name="recpId[]" type="checkbox" value="<?php echo $vo['id']; ?>" <?php if(in_array($vo['id'],$recData)): ?>checked<?php endif; ?> class="colored-blue">
                            ...
                            <div class="tab-pane" id="desc-tab">
                                <div id="desc" class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea name="desc" id="details"><?php echo $goodsData['desc']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="member-tab">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2 radio">
                                        <label>
                                            <input id="mp" class="checkbox-slider slider-icon yesno" name="status" value="1" <?php if($goodsData['status'] == 1): ?>checked<?php endif; ?> type="checkbox">
                                            <span class="text"></span>
                                        </label>
                                    </div>
                                </div>
                                <?php if(empty($mpData) || (($mpData instanceof \think\Collection || $mpData instanceof \think\Paginator ) && $mpData->isEmpty())): ?>
                                ...
                                <div class="form-group" id="mprice">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 col-md-2 col-sm-2 col-xs-9 control-label no-padding-right"><?php echo $vo['levelName']; ?></label>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-9 no-padding-right">
                                            <input class="form-control" mp="mp" placeholder="留空按折扣算" name="mp[<?php echo $vo['id']; ?>]" value="<?php echo $mpData[$vo['id']]; ?>" type="text">
                                        </div>
                                        <div class="radio col-lg-1 col-md-1 col-sm-1 col-xs-1">
                                            <span class="text">
                                                ￥
                                    ...
                                    <div class="form-group" name="attrs">
                                        ...
                                        <div class="col-lg-3">
                                            <select class="form-control" name="attrVal[<?=$v['attrId']?>][]">
                                                ...
                                                <?php $attr = explode(',',$v['attrValues']);foreach($attr as $k1 => $v1):
                                                        if($v['attrVal'] == $v1) {
