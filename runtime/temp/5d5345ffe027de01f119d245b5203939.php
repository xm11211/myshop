<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/www.xxsucai.com/public/../application/member/view/account/login.html";i:1527896026;}*/ ?>
<!doctype html>
<html>
<head>
...
var loginUrl = "<?php echo url('member/account/login'); ?>";
</script>
</head>
    ...
    <div class="loginRegister-header">
        <div class="w w1200">
            ...
            <div class="header-href">
                            <span>还没有账号<a href="/reg.html" class="jump">免费注册</a></span>
                        </div>
        </div>
    </div>
    <div class="container">
                        ...
                        <div class="form">
                            <form name="formLogin"  method="post" onSubmit="userLogin();return false;">
                                ...
                                <div class="item item-button">
                                    ...
                                    <input type="hidden" name="back_act" value="<?php echo SITEURL;?>" autocomplete="off" />
                                    <input type="hidden" name="dsc_token" value="<?php echo \think\Request::instance()->token('dsc_token'); ?>" />
                                    <input type="submit" name="submit" id="loginSubmit" value="登&nbsp;&nbsp;录" class="btn sc-redBg-btn">
                                </div>
                                <a href="/getpassword.html" class="notpwd gary">忘记密码？</a>
                            </form>
                        </div>
                    </div>
                </div>
            </div>
            <a class="login-banner" href="https://www.dscmall.cn/" target="_blank" style="background:url(/static/Home/img/1488936109167439630.jpg) center center no-repeat;"></a>
