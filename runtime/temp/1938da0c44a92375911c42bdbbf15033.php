        ...
        <div class="article-main">
            ...
            <div class="am-bd">
                <ul class="artilce-list">
                    ...
                    <li>
                        <h3><a href="/article/<?php echo $vo['id']; ?>" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a></h3>
                        <p></p>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
