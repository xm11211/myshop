<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"F:\day\myshop\public/../application/index\view\goods\index.html";i:1540950684;s:55:"F:\day\myshop\application\index\view\common\header.html";i:1541134761;s:54:"F:\day\myshop\application\index\view\common\right.html";i:1519852424;s:55:"F:\day\myshop\application\index\view\common\footer.html";i:1540963004;}*/ ?>
<!doctype html>
<html>
<head>
...
var ajaxAddToCart = "<?php echo url('index/flow/addToCart'); ?>";
var cart = "<?php echo url('index/flow/cart'); ?>";
var getCartNum = "<?php echo url('index/flow/getCartNum'); ?>";
</script><link rel="stylesheet" type="text/css" href="/static/Home/css/goods_fitting.css" />
<link rel="stylesheet" type="text/css" href="/static/Home/css/suggest.css" />
<link rel="stylesheet" type="text/css" href="/static/Home/js/calendar/calendar.min.css" />
<link rel="stylesheet" type="text/css" href="/static/Home/js/perfect-scrollbar/perfect-scrollbar.min.css" />
</head>
<body>
...
<li><a href="category.php?id=455">大码女装</a></li>
			...
			<i class="iconfont icon-right"></i>		</div>
<span class="cn-goodsName"><?php echo $goodsData['goodsName']; ?></span>
			</div>
</div>
        </div>
    </div>
...
<div class="preview" if="preview">
	<div class="gallery_wrap"><a href="/static/upload/<?php echo $photoData[0]['photo']; ?>" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: img-hover; selectors-change: mouseover; zoom-distance: 10;zoom-width: 400; zoom-height: 474;"><img src="/static/upload/<?php echo $photoData[0]['bigPhoto']; ?>" id="J_prodImg" alt="<?php echo $goodsData['goodsName']; ?>"></a></div>
	<div class="spec-list">
		<a href="javascript:void(0);" class="spec-prev"><i class="iconfont icon-left"></i></a>
		<div class="spec-items">
			<ul>
                <?php if(is_array($photoData) || $photoData instanceof \think\Collection || $photoData instanceof \think\Paginator): $i = 0; $__LIST__ = $photoData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li>
                    <a href="/static/upload/<?php echo $vo['photo']; ?>" rel="zoom-id: Zoomer" rev="/static/upload/<?php echo $vo['bigPhoto']; ?>">
                    <img src="/static/upload/<?php echo $vo['smPhoto']; ?>" alt="<?php echo $goodsData['goodsName']; ?>" width="58" height="58" />
					</a>
				</li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
...
<form action="javascript:addToCart(799)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
                		<div class="name"><?php echo $goodsData['goodsName']; ?></div>
            <div class="summary">
        <div class="summary-price-wrap">
            <div class="s-p-w-wrap">
                <div class="summary-item si-shop-price">
                    <?php if(isset($goodsData['memPrice'])): ?>
                    <div class="si-tit">会 员 价</div>
                    <div class="si-warp">
                        <strong class="shop-price" id="ECS_SHOPPRICE" ectype="SHOP_PRICE"><?php echo $goodsData['memPrice']; ?></strong>
                        <span class="price-notify" data-userid="62" data-goodsid="799" ectype="priceNotify">降价通知</span>
                    </div>
                    <?php else: ?>
<div class="si-tit">商 城 价</div>
<div class="si-warp">
    <strong class="shop-price" id="ECS_SHOPPRICE" ectype="SHOP_PRICE"><?php echo $goodsData['shopPrice']; ?></strong>
    <span class="price-notify" data-userid="62" data-goodsid="799" ectype="priceNotify">降价通知</span>
</div>
                    <?php endif; ?>
                </div>
...
<div class="si-warp"><div class="m-price" id="ECS_MARKETPRICE"><em>¥</em><?php echo $goodsData['marketPrice']; ?></div></div>
                </div>
            <div class="si-info">
...
<div class="si-warp">
        ...
        <div class="summary-basic-info">
            ...
            <?php if($radioAttr): if(is_array($radioAttr) || $radioAttr instanceof \think\Collection || $radioAttr instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="summary-item is-integral">
                <div class="si-tit"><?php echo $vo[0]['attrName']; ?></div>
                <div class="si-warp">
                    ...
                    <label <?php if($i == 1): ?> class="check-status" <?php endif; ?>><input type="radio" name="attr_<?php echo $vo1['attrId']; ?>" <?php if($i == 1): ?> checked="checked" <?php endif; ?> value="<?php echo $vo1['id']; ?>" ><?php echo $vo1['attrVal']; ?></label>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
            ...
            <script>
                $(function () {
                    $(".si-warp label").each(function (k,v) {
                        $(v).on('click',function () {
                            $(this).addClass("check-status").siblings().removeClass("check-status").children("input").removeAttr("checked");
...
<div class="amount-warp">
    ...
    <div class="a-btn">
        ...
        <input type="hidden" name="perNumber" id="perNumber" ectype="perNumber" value="500">
...
<span>库存&nbsp;<em id="goods_attr_num" ectype="goods_attr_num">500</em>&nbsp;个</span>
                </div>
            </div>
            <div class="clear"></div>
        </div>
        <div class="choose-btns ml60 clearfix">
        <a href="javascript:bool=0;addToCart(<?php echo $goodsData['id']; ?>)" data-type="0" class="btn-buynow" ectype="btn-buynow">立即购买</a>
    <a href="javascript:bool=0;addToCart(<?php echo $goodsData['id']; ?>,true)" class="btn-append" ectype="btn-append"><i class="iconfont icon-carts"></i>加入购物车</a>
...
<div class="track_warp">
    ...
    <div class="track-con" style="height:450px;">
        <ul>
    <li>
                <div class="p-img"><a href="goods.php?id=635" target="_blank" title="韩都衣舍2017韩版女装新款黑白拼接插肩棒球服春季短外套HH5597妠 朴信惠同款 黑白拼接 插肩袖 棒球服"><img src="/static/Home/img/0_thumb_G_1489102950633.jpg" width="140" height="140"></a></div>
    ...
    <li>
                <div class="p-img"><a href="goods.php?id=634" target="_blank" title="新款韩版chic学生宽松短款外套上衣字母长袖连帽套头卫衣女潮"><img src="/static/Home/img/0_thumb_G_1489102753231.jpg" width="140" height="140"></a></div>
    ...
    <li>
                <div class="p-img"><a href="goods.php?id=864" target="_blank" title="马克华菲长袖T恤男士圆领修身韩版刺绣纯棉2017春装新款潮t 7002 立体3D绣花 欧美潮流范 17春装新品"><img src="/static/Home/img/0_thumb_G_1490211620029.jpg" width="140" height="140"></a></div>
    ...
    <li>
                <div class="p-img"><a href="goods.php?id=785" target="_blank" title="森马夹克 2016冬装新款男士飞行夹克贴布绣立领休闲外套韩版潮流"><img src="/static/Home/img/0_thumb_G_1490174208112.jpg" width="140" height="140"></a></div>
    ...
    <li>
                <div class="p-img"><a href="goods.php?id=625" target="_blank" title="秋季新款男士套头卫衣印花外套韩版简约百搭潮流男生上衣服"><img src="/static/Home/img/0_thumb_G_1489099437211.jpg" width="140" height="140"></a></div>
...
<div class="mc-main" style="display:block;">
	...
	<div class="mcm-right">
		<ul>
<li>
				<div class="p-img"><a href="goods.php?id=864" title="马克华菲长袖T恤男士圆领修身韩版刺绣纯棉2017春装新款潮t 7002 立体3D绣花 欧美潮流范 17春装新品"><img src="/static/Home/img/0_thumb_G_1490211620029.jpg" width="130" height="130"></a></div>
...
<li>
				<div class="p-img"><a href="goods.php?id=863" title="马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98"><img src="/static/Home/img/0_thumb_G_1490211575591.jpg" width="130" height="130"></a></div>
				<div class="p-name"><a href="goods.php?id=863" title="马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98">马克华菲长袖T恤男 冬季新品纯棉圆领黑白潮款印花休闲t恤   98</a></div>
				<div class="p-price">
					<em>¥</em>98.00			</div>
			</li>
<li>
				<div class="p-img"><a href="goods.php?id=865" title="美特斯邦威长袖T恤男士2017春装新款时尚印花百搭205064商场同款 1元秒100元优惠券丨限量抢丨立即抢购"><img src="/static/Home/img/0_thumb_G_1490211700709.jpg" width="130" height="130"></a></div>
...
<div class="g-main g-history">
	...
	<div class="mc">
		<div class="mc-warp" id="history_list" ectype="history_mian">
			<ul>
				                				<li>
					<div class="p-img"><a href="goods.php?id=799" target="_blank" title="韩美格2017春秋新款修身大码蕾丝网纱打底衫女长袖薄款圆领女T恤 全店商品 二件减5元 三件减10"><img src="/static/Home/img/0_thumb_G_1490174858999.jpg" width="170" height="170"></a></div>
...
<div class="p-price">
			<em>¥</em>68.00	</div>
                				                				...
                				                				<li>
					<div class="p-img"><a href="goods.php?id=626" target="_blank" title="秋冬新款加绒圆领套头卫衣男青年男生韩版潮流学生休闲外套男"><img src="/static/Home/img/0_thumb_G_1489099544749.jpg" width="170" height="170"></a></div>
...
<div class="p-price">
			<em>¥</em>168.00	</div>
                				                				...
                				                				<li>
					<div class="p-img"><a href="goods.php?id=865" target="_blank" title="美特斯邦威长袖T恤男士2017春装新款时尚印花百搭205064商场同款 1元秒100元优惠券丨限量抢丨立即抢购"><img src="/static/Home/img/0_thumb_G_1490211700709.jpg" width="170" height="170"></a></div>
...
<div class="p-price">
			<em>¥</em>89.00	</div>
                				                				...
                				                				<li>
					<div class="p-img"><a href="goods.php?id=775" target="_blank" title="韩都衣舍2017韩版女装春装新款条纹显瘦百搭宽松v领七分袖衬衫潮 领券立减/单件包邮/七天无理由退换"><img src="/static/Home/img/0_thumb_G_1490169281436.jpg" width="170" height="170"></a></div>
...
<div class="p-price">
			<em>¥</em>78.00	</div>
                				                				...
                				                				<li>
					<div class="p-img"><a href="goods.php?id=768" target="_blank" title="韩都衣舍2017韩版女装夏装新款时尚修身显瘦圆领条纹T恤OGY7711娋 显瘦版型 舒适面料 条纹元素"><img src="/static/Home/img/0_thumb_G_1490169030833.jpg" width="170" height="170"></a></div>
...
<div class="gm-floors" ectype="gm-floors">
    <div class="gm-f-item gm-f-details" ectype="gm-item">
        ...
        <div class="goods-para-list">
            <dl class="goods-para">
                <?php if(is_array($uniqueAttr) || $uniqueAttr instanceof \think\Collection || $uniqueAttr instanceof \think\Paginator): $i = 0; $__LIST__ = $uniqueAttr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <dd class="column"><span><?php echo $vo['attrName']; ?>：<?php echo $vo['attrVal']; ?></span></dd>
                <?php endforeach; endif; else: echo "" ;endif; ?>
        <dd class="column"><span>上架时间：<?php echo date('Y/m/d h:i:s',$goodsData['time']); ?></span></dd>
        </dl>
...
<ul>
            <li>
        <div class="p-img"><a href="goods.php?id=684" target="_blank"><img src="/static/Home/img/0_thumb_G_1489109583798.jpg" width="134" height="134"></a></div>
        ...
        <div class="p-price"><em>¥</em>555.00</div>
                ...
                <li>
        <div class="p-img"><a href="goods.php?id=685" target="_blank"><img src="/static/Home/img/0_thumb_G_1489109633806.jpg" width="134" height="134"></a></div>
        ...
        <div class="p-price"><em>¥</em>1000.00</div>
                ...
                <li>
        <div class="p-img"><a href="goods.php?id=679" target="_blank"><img src="/static/Home/img/0_thumb_G_1489108999364.jpg" width="134" height="134"></a></div>
        ...
        <div class="p-price"><em>¥</em>200.00</div>
                ...
                <li>
        <div class="p-img"><a href="goods.php?id=634" target="_blank"><img src="/static/Home/img/0_thumb_G_1489102753231.jpg" width="134" height="134"></a></div>
        ...
        <div class="p-price"><em>¥</em>300.00</div>
                ...
                <li>
        <div class="p-img"><a href="goods.php?id=683" target="_blank"><img src="/static/Home/img/0_thumb_G_1489109337889.jpg" width="134" height="134"></a></div>
...
<div class="btns">
    <a href="<?php echo url('index/flow/cart'); ?>" class="ecsc-btn-mini ecsc-btn-orange">去付款</a>
...
<script type="text/javascript" src="/static/Home/js/warehouse.js"></script><script type="text/javascript" src="/static/Home/js/warehouse_area.js"></script>
    ...
    <script type="text/javascript" src="/static/Home/js/jquery.SuperSlide.2.1.1.js"></script><script type="text/javascript" src="/static/Home/js/jquery.yomi.js"></script><script type="text/javascript" src="/static/Home/js/common.js"></script><script type="text/javascript" src="/static/Home/js/compare.js"></script><script type="text/javascript" src="/static/Home/js/cart_common.js"></script><script type="text/javascript" src="/static/Home/js/magiczoomplus.js"></script><script type="text/javascript" src="/static/Home/js/cart_quick_links.js"></script>    <script type="text/javascript" src="/static/Home/js/calendar.php?lang="></script>
    ...
    <script type="text/javascript" src="/static/Home/js/goodsFittings.js"></script>
