...
function userLogin()
{
	...
	Ajax.call( '' + loginUrl + '',
        'username=' + username.val()+'&password='+password.val()+'&remember='+remember_string+'&captcha='+captcha.val()+'&dsc_token='+dsc_token.val()+'&back_act='+back_act,
        return_login , 'POST', 'JSON');
    // $.ajax({
    //     url:loginUrl,
    //     type:'post',
    //     data:{username:username.val(),password:password.val(),remember:remember_string,dsc_token:dsc_token.val()},
