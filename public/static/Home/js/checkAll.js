...
$(function(){
	...
	{   
		Ajax.call(cartGoodsAmount, 'rec_id=' + rec_id, change_cart_goods_response, 'POST','JSON');                
	}
	...
	function replace_cart_goods(rec_id, favourable_id, $this)
	{
		...
		Ajax.call(cartGoodsAmount, 'rec_id=' + rec_id + select_flag + ajax_where, replace_cart_goods_response, 'POST','JSON');                
	}
